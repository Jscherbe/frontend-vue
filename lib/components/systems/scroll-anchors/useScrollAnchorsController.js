...
/**
 * @internal
 * Core controller for the Scroll Anchors system.
 * Encapsulates the IntersectionObserver logic to track sections, manage their
 * active state, and handle edge cases when scrolling past boundaries.
 * This composable is not intended for public use.
 * @param {{sections: object, props: object, emit: Function}} options
 */
export function useScrollAnchorsController({ sections, props, emit }) {
  let observer = null;
