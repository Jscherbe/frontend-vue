...
export const SidebarLayoutWithAndLogic = (args) => ({
  components: {
    UluFacetsFilterLists,
    UluFacetsResults,
    UluFacetsSearch,
  ...
  template: `
    <div>
      <p>This story demonstrates the 'AND' logic for multi-select filters. Select multiple categories to see that only items belonging to ALL selected categories are shown.</p>
      <br/>
      <UluFacetsSidebarLayout>
        <template #header>
          <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid #eee;">
...
SidebarLayoutWithAndLogic.args = {
  facetFields: [
