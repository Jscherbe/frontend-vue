import UluCollapsibleRegion from './UluCollapsibleRegion.vue';

export default {
  title: 'Components/Collapsible/UluCollapsibleRegion',
  component: UluCollapsibleRegion,
  tags: ['autodocs'],
  ...
  render: (args) => ({
    components: { UluCollapsibleRegion },
    setup() {
      return { args };
    },
    template: `
