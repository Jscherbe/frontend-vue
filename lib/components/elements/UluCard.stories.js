...
export default {
  ...
  args: {
    title: 'Card Title',
    image: {
      src: 'https://picsum.photos/id/1062/400/225',
      alt: 'Placeholder image of a landscape',
    },
...
export const TitleAsRouterLink = {
  args: {
    title: 'This title is a router-link',
    titleTo: { path: '/example' },
  }
};
...
export const ProxyClickTitleRouterLink = {
  args: {
    title: 'This title is a router-link',
    titleTo: { path: '/example' },
    proxyClick: true,
