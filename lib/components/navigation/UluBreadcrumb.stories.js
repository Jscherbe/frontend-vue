...
export const PerItemClasses = Template.bind({});
PerItemClasses.args = {
  items: [
    { title: 'Home', to: { path: '/' }, classes: { item: 'custom-item-class', link: 'custom-link-class' } },
    { title: 'Parent Page', to: { path: '/parent' } },
    { title: 'Current Page', to: { path: '/parent/current' }, current: true, classes: { current: 'text-bold' } },
  ],
};
