import{C as l,D as s,I as u}from"./iframe-2PTns7KC.js";import"./preload-helper-BJwshlQW.js";const c={component:l,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the text input."},modelValue:{control:"text",description:"The value of the text input (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:s,UluFormText:l},setup(){return{args:r}},template:`
  ...
  args: {}
}`,...o.parameters?.docs?.source}}};const p=["Default","Required","CustomRequiredLabel","LabelHidden","VModel"];export{n as CustomRequiredLabel,e as Default,a as LabelHidden,t as Required,o as VModel,p as __namedExportsOrder,c as default};
