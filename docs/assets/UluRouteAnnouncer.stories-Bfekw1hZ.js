import{h as p,c as h,L as m,J as g,e as f,d as b,t as v,a0 as T,o as y,M as U}from"./iframe-dqyhXnFM.js";import{g as A}from"./router-B1jYtMfx.js";import{_ as k}from"./UluButton-D2i34N9E.js";import"./preload-helper-BJwshlQW.js";import"./UluAction-DE1y6pLT.js";import"./props-DEaRQ31f.js";const l={__name:"UluRouteAnnouncer",props:{validator:{type:Function,default:()=>!0},exclude:{type:Array,default:()=>[]},getTitle:{type:Function,default:e=>A(e)}},setup(e){const t=e,o=m(),a=p(null),s=h(()=>{if(!o)return"";const n=t.getTitle(o);return n||console.warn("RouteAnnouncer: No page title!"),n});return o?g(()=>o.path,async(n,c)=>{if(o.hash)return;const i=t.validator(n,c,o),d=t.exclude.some(u=>u.endsWith("*")?n.startsWith(u.slice(0,u.length-1)):n===u);i&&!d&&(await T(),a.value?.focus())}):console.error("RouteAnnouncer: No route found (install vue-router)."),(n,c)=>s.value?(y(),f("p",{key:0,tabindex:"-1",class:"hidden-visually",ref_key:"el",ref:a},v(s.value),513)):b("",!0)}};l.__docgenInfo={exportName:"default",displayName:"UluRouteAnnouncer",description:"",tags:{},props:[{name:"validator",description:`Allow user to bypass this functionality
...
}`,...r.parameters?.docs?.source}}};const F=["Default"];export{r as Default,F as __namedExportsOrder,O as default};
