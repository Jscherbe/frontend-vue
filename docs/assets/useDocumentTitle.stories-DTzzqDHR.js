import{an as y,ao as g,ap as b,y as x,i as r,a9 as h,a3 as w,aq as M,ar as R,a1 as D,N as k,V as C,Q as H,a as E,d as U,L as f,ad as A,X as I}from"./iframe-5nAqi7QD.js";import{g as j}from"./router-B1jYtMfx.js";import"./preload-helper-BJwshlQW.js";function p(t,e,n){typeof t==="function"&&(!n||n!=="titleTemplate"&&!(n[0]==="o"&&n[1]==="n"))&&(t=t());let o;if(e&&(o=e(n,t)),Array.isArray(o))return o.map(s=>p(s,e));if(o?.constructor===Object){const s={};for(const i of Object.keys(o))s[i]=p(o[i],e,i);return s}return o}const O=(t,e)=>g(e)?y(e):e,P="usehead";function S(){if(b()){const t=x(P);if(!t)throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.");return t}throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.")}function z(t,e={}){const n=e.head||S();return n.ssr?n.push(t||{},e):_(n,t,e)}function _(t,e,n={}){const a=r(!1);let o;return h(()=>{const i=a.value?{}:p(e,O);o?o.patch(i):o=t.push(i,n)}),D()&&(w(()=>{o.dispose()}),M(()=>{a.value=!0}),R(()=>{a.value=!1})),o}const m=H({});function T(t={}){const{title:e,titleTemplate:n="%s",useRoute:a=k,useHead:o=z}=t,s=a(),i=s.path;if(e!==void 0){h(()=>{m[i]=U(e)}),C(()=>{delete m[i]});return}const l=E(()=>{const u=m[s.path],v=j(s,s),d=u||v;return d?n.replace("%s",d):"App"});o({title:l})}const $={title:"Composables/useDocumentTitle"},c={name:"Interactive Demo",render:()=>({setup(){const t=r(""),e=l=>{f(l.title,u=>{t.value=u},{immediate:!0})},n=r({path:"/story-route",meta:{title:"Default Meta Title"}}),a=()=>n.value;T({titleTemplate:"Test Title: %s",useRoute:a,useHead:e});const o=r(""),s=r("Default Meta Title"),i=A({setup:()=>(T({title:o,useRoute:a}),()=>I("div",{style:"font-size: 12px; color: #666; margin-top: 10px;"}," "))});return f(s,l=>{n.value={path:"/story-route",meta:{title:l}}}),{componentTitle:o,routeMetaTitle:s,headTitle:t,MockPageComponent:i}},template:`
      <div>
...
}`,...c.parameters?.docs?.source}}};const q=["InteractiveDemo"];export{c as InteractiveDemo,q as __namedExportsOrder,$ as default};
