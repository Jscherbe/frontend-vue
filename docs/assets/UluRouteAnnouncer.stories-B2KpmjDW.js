import{i as h,a as m,N as f,L as b,O as d,f as v,e as T,t as U,a5 as y,a2 as A,o as k}from"./iframe-5nAqi7QD.js";import{g as w}from"./router-B1jYtMfx.js";import{_ as R}from"./UluButton-BbYbcMHh.js";import"./preload-helper-BJwshlQW.js";import"./UluAction-DBju86YK.js";const i={__name:"UluRouteAnnouncer",props:{validator:{type:Function,default:()=>!0},exclude:{type:Array,default:()=>[]},getTitle:{type:Function,default:e=>w(e)},debug:Boolean},setup(e){const t=e,n=f(),l=d(),c=h(null),u=m(()=>{if(!n||n.matched.length===0)return"";const o=t.getTitle(n);return o||console.warn("RouteAnnouncer: No page title!"),o});return l?b(l.currentRoute,async(o,a)=>{if(a===y||a.matched.length===0||o.hash)return;const p=t.validator(o,a),g=t.exclude.some(r=>r.endsWith("*")?o.path.startsWith(r.slice(0,r.length-1)):o.path===r);u.value&&p&&!g&&(t.debug&&console.log("RouteAnnouncer: Focused title:",u.value),await A(),c.value?.focus())}):console.error("RouteAnnouncer: No route found (install vue-router)."),(o,a)=>u.value?(k(),v("p",{key:0,tabindex:"-1",class:"hidden-visually",ref_key:"el",ref:c},U(u.value),513)):T("",!0)}};i.__docgenInfo={exportName:"default",displayName:"UluRouteAnnouncer",description:"",tags:{},props:[{name:"validator",description:`Allow user to bypass this functionality
