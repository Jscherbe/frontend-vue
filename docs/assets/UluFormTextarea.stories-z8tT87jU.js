import{_ as s}from"./UluFormTextarea-BtN8PTMd.js";import{_ as l}from"./UluFormItem-CPgFepU-.js";import{l as u}from"./iframe-DEu6WBfK.js";import"./UluFormRequiredChar-DzmmNLaj.js";import"./preload-helper-BJwshlQW.js";const g={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
