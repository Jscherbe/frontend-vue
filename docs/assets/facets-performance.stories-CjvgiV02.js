import{l as S}from"./fontawesome-DyrJdE5N.js";import{_ as U,u as P}from"./UluFacetsFilterAccordions-Ckrl6TPg.js";import{u as _}from"./usePagination-CdZajqdu.js";import{_ as A,a as C,b as x,c as T}from"./UluFacetsSort-BJhi6xPS.js";import{_ as I}from"./UluPager-BDc-tGyZ.js";import"./UluSelectableMenu-C_zKnLMN.js";import"./UluAccordion-Cyue6xpY.js";import"./iframe-DFeB4tIX.js";import"./preload-helper-BJwshlQW.js";import"./UluCollapsible-D3pFdfZ-.js";const q={parameters:{chromatic:{disableSnapshot:!0}}},O=e=>{const o=S(e.items),{facets:t,searchValue:i,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=P(o,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=_(l,e.itemsPerPage);return{args:e,facets:t,searchValue:i,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},w=`
...
})`,...r.parameters?.docs?.source}}};const z=["PerformanceTestIntuitive"];export{r as PerformanceTestIntuitive,z as __namedExportsOrder,q as default};
