import{_ as t}from"./UluFormRadio-ssFGClMs.js";import{_ as a}from"./UluFormItem-u0a0aoQ2.js";import{l as m}from"./iframe-syB0z-8X.js";import"./UluFormRequiredChar-B6WPMUun.js";import"./preload-helper-BJwshlQW.js";const p={component:t,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"text"},value:{control:"text"},name:{control:"text"},required:{control:"boolean"}}},e={render:l=>({components:{UluFormItem:a,UluFormRadio:t},setup(){const r=m("option2");return{args:l,selectedValue:r}},template:`
