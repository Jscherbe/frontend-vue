import{Y as S,Z as U,$ as P,a0 as _,a1 as C,z as x}from"./iframe-QLzdo_GC.js";import{u as T}from"./useFacets-C-9S5Dyr.js";import{u as A}from"./usePagination-CMCxRFLy.js";import{_ as I}from"./UluPager-cCTf_SQR.js";import"./preload-helper-BJwshlQW.js";const E={parameters:{chromatic:{disableSnapshot:!0}}},L=e=>{const i=x(e.items),{facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=T(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=A(l,e.itemsPerPage);return{args:e,facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},O=`
