import{O as s,D as l,I as u}from"./iframe-sn1yWKrl.js";import"./preload-helper-BJwshlQW.js";const c={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
  ...
  args: {}
}`,...o.parameters?.docs?.source}}};const p=["Default","Required","CustomRequiredLabel","LabelHidden","VModel"];export{t as CustomRequiredLabel,e as Default,n as LabelHidden,a as Required,o as VModel,p as __namedExportsOrder,c as default};
