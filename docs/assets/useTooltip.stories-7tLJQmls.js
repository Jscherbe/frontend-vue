import{aD as c,b7 as r,b8 as p,b9 as u,P as d}from"./iframe---2PRveq.js";import"./preload-helper-BJwshlQW.js";function b(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
