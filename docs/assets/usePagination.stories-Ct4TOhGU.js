import{q as p}from"./iframe-Cct7deJN.js";import{u}from"./usePagination-DT38wx7E.js";import{_ as g}from"./UluPager-COy-3cMR.js";import"./preload-helper-BJwshlQW.js";const b={parameters:{chromatic:{disableSnapshot:!0},notes:"This story demonstrates the `usePagination` composable. It requires a `vue-router` instance to be provided to the application, as it interacts with the route query to manage the page state. If the pager links do not work, it is because the router is not configured in Storybook."}},l={components:{UluPager:g},props:{itemsPerPage:{type:Number,default:10}},template:`
    <div>
