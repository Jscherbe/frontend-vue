import{q as p,r}from"./iframe-C5bsz2kF.js";import"./preload-helper-BJwshlQW.js";const y={component:r,tags:["autodocs"],argTypes:{type:{control:{type:"select",options:Object.keys(p().iconsByType)}},definition:{control:"text"}}},a=o=>({components:{UluIcon:r},setup(){return{args:o}},template:'<UluIcon v-bind="args" />'}),t=a.bind({});t.args={type:"info"};const s=o=>({components:{UluIcon:r},setup(){const i=Object.keys(p().iconsByType);return{args:o,types:i}},template:`
