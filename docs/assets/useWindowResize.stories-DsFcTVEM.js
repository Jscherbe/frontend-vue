import{h as s,T as g,c as m}from"./iframe-DLKis_3v.js";import{u as z}from"./useWindowResize-Pc80EPRg.js";import"./preload-helper-BJwshlQW.js";const h={template:`
  ...
  `,setup(){const{resizing:r,onResizeStart:a,onResizeEnd:i}=z(),e=s("Ready"),o=s(0),n=s(0),d=()=>{e.value="Started resizing...",o.value++},u=()=>{e.value="Finished resizing (debounced 300ms)",n.value++},c=a(d),l=i(u);g(()=>{c(),l(),console.log("Resize listeners cleaned up.")});const p=m(()=>e.value.startsWith("Started")?"blue":e.value.startsWith("Finished")?"green":"black");return{resizing:r,status:e,statusColor:p,startCount:o,endCount:n}}},C={title:"Composables/useWindowResize",component:h},t={};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"{}",...t.parameters?.docs?.source}}};const v=["Default"];export{t as Default,v as __namedExportsOrder,C as default};
