import{$ as S,a2 as P,a3 as U,a4 as A,a5 as C,a6 as _,P as x}from"./iframe-BAda3xFs.js";import{u as T}from"./useFacets-BONA5rwS.js";import{u as I}from"./usePagination-C9Rk3n-L.js";import"./preload-helper-BJwshlQW.js";const j={parameters:{chromatic:{disableSnapshot:!0}}},O=e=>{const i=x(e.items),{facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=T(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=I(l,e.itemsPerPage);return{args:e,facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},w=`
