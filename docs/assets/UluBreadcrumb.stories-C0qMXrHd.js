import{e as l,d as b,k as U,F as k,z as y,n as t,A as v,o as s,a as _,r as i,w as S,f as g,t as f,l as h,_ as C}from"./iframe-DLKis_3v.js";import"./preload-helper-BJwshlQW.js";const u={__name:"UluBreadcrumb",props:{items:{type:Array,default:()=>[]},separatorIcon:String,classes:{type:Object,default:()=>({nav:"breadcrumb",list:"breadcrumb__list",item:"breadcrumb__item",link:"breadcrumb__link",current:"breadcrumb__current",separator:"breadcrumb__separator"})}},setup(e){return(m,P)=>{const B=v("router-link");return e.items.length?(s(),l("nav",{key:0,class:t(e.classes.nav),"aria-label":"Breadcrumb"},[U("ol",{class:t(e.classes.list)},[(s(!0),l(k,null,y(e.items,(r,d)=>(s(),l("li",{key:d,class:t([e.classes.item,r?.classes?.item])},[r.current?(s(),l("span",{key:1,class:t([e.classes.current,r?.classes?.current])},[i(m.$slots,"default",{item:r},()=>[g(f(r.title),1)])],2)):(s(),_(B,{key:0,to:r.to,class:t([e.classes.link,r?.classes?.link]),"aria-current":r.current?"page":null},{default:S(()=>[i(m.$slots,"default",{item:r},()=>[g(f(r.title),1)])]),_:2},1032,["to","class","aria-current"])),d<e.items.length-1?i(m.$slots,"separator",{key:2},()=>[h(C,{class:t([e.classes.separator,r?.classes?.separator]),icon:e.separatorIcon||"type:pathSeparator"},null,8,["class","icon"])]):b("",!0)],2))),128))],2)],2)):b("",!0)}}};u.__docgenInfo={exportName:"default",displayName:"UluBreadcrumb",description:"",tags:{},props:[{name:"items",description:`Array of breadcrumb items.
