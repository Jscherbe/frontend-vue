import{e as u,k as p,t as m,o as v,E as g,h as l}from"./iframe-dqyhXnFM.js";import"./preload-helper-BJwshlQW.js";const h={style:{"text-align":"center"}},C={style:{margin:"0 0 0.5rem 0","font-size":"1rem"}},c={__name:"StoryTooltipComponent",props:{title:String},setup(t){return(n,e)=>(v(),u("div",h,[p("h4",C,m(t.title||"no title"),1),e[0]||(e[0]=p("p",{style:{margin:"0","font-size":"0.875rem"}},"This is a Vue component being rendered inside a tooltip.",-1))]))}};c.__docgenInfo={exportName:"default",displayName:"StoryTooltipComponent",description:"",tags:{},props:[{name:"title",type:{name:"string"}}],sourceFiles:["/Users/joe/Projects/Personal/Github/frontend-vue/lib/plugins/popovers/tests/StoryTooltipComponent.vue"]};const T={tags:["autodocs"],argTypes:{content:{control:"text",description:"The text to display in the tooltip."}}},o=t=>({setup(){return{args:t}},template:`
    <div style="padding: 5rem; text-align: center;">
      <span tabindex="0" v-ulu-tooltip="args.content">
        Hover over me
      </span>
    </div>
  `});o.args={content:"This is a basic tooltip!"};const a=t=>({setup(){const n=l(1),e=l(`This is a reactive tooltip. Count: ${n.value}`);return{args:t,content:e,updateCount:()=>{n.value++,e.value=`The count has been updated to: ${n.value}`}}},template:`
    <div style="padding: 5rem; text-align: center;">
      <p>
  ...
  \`
})`,...r.parameters?.docs?.source}}};const x=["Basic","ReactiveContent","HtmlContent","ComponentContent","InModal"];export{o as Basic,i as ComponentContent,s as HtmlContent,r as InModal,a as ReactiveContent,x as __namedExportsOrder,T as default};
