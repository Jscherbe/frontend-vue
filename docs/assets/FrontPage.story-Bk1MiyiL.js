import{I as e}from"./jsx-runtime-CKVpSx3H.js";import{useMDXComponents as r}from"./index-DIzwWG-n.js";import{M as l,C as i}from"./blocks-Bj6r1-3x.js";import{Primary as s}from"./UluButton.stories-uvrJpyH0.js";import{Default as c}from"./UluCard.stories-DUIHsuel.js";import{r as a}from"./index-vwjNkSeb.js";import"./fontawesome-DyrJdE5N.js";import"./preload-helper-BJwshlQW.js";import"./iframe-DFeB4tIX.js";import"./UluButton-zu_C2qC9.js";import"./UluAction-CSWkOuPE.js";import"./props-DEaRQ31f.js";import"./UluCard-Bsrn2eZm.js";import"./UluImage-82esh8i6.js";function t(o){const n={a:"a",code:"code",em:"em",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...o.components};return e(a.Fragment,{children:[e(l,{title:"Overview/Introduction"}),`
...
`})}),`
`,e(n.h3,{id:"vite-asset-urls",children:"Vite Asset URLs"}),`
`,e(n.p,{children:["When using components like ",e(n.code,{children:"UluImage"})," and ",e(n.code,{children:"UluImageSource"}),", you may want to pass relative asset paths directly as props (e.g. ",e(n.code,{children:'<UluImage src="./assets/img.png" />'}),") instead of manually importing them in your setup script."]}),`
`,e(n.p,{children:["To enable Vite to automatically resolve these paths, you can add our custom transform rules to the Vue plugin in your ",e(n.code,{children:"vite.config.js"}),":"]}),`
`,e(n.p,{children:e(n.em,{children:"Note: this includes the defaults (img, source, video, ...) in addition to the Ulu specific components, since configuring this clears the defaults (it's not merged)."})}),`
`,e(n.pre,{children:e(n.code,{className:"language-js",children:`// vite.config.js
...
`})})]})}function T(o={}){const{wrapper:n}={...r(),...o.components};return n?e(n,{...o,children:e(t,{...o})}):t(o)}const k=[];export{k as __namedExportsOrder,T as default};
