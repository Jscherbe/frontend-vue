...
If not provided, it defaults to the visible width of the track.`,type:{name:"number|string"},defaultValue:{func:!1,value:"'auto'"}},{name:"scrollBehavior",description:"Scroll behavior ('smooth' or 'auto').",type:{name:"string"},defaultValue:{func:!1,value:"'smooth'"}},{name:"emptySlides",description:"Include empty start and end slides (needed for correct margin collapsing with some styles).",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"observerOptions",description:'Options passed to the IntersectionObserver (determines when a slide is considered "intersecting").',type:{name:"object"},defaultValue:{func:!1,value:`{
  threshold: 0.1
}`}},{name:"modifiers",description:"Base class modifiers.",type:{name:"string|array"}}],slots:[{name:"slide",scoped:!0,bindings:[{name:"item",title:"binding"},{name:"index",title:"binding"},{name:"isIntersecting",title:"binding"}]},{name:"previous"},{name:"next"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/elements/UluScrollSlider.vue"]};const Z={component:w,tags:["autodocs"],argTypes:{items:{control:"object"},controls:{control:"boolean"},scrollAmount:{control:"number"},scrollBehavior:{control:"select",options:["smooth","auto"]},modifiers:{control:"text"}}},K=Array.from({length:10}).map((e,n)=>({id:n+1,title:`Card Title ${n+1}`,imageSrc:`https://picsum.photos/seed/${n+50}/400/225`,imageAlt:`Placeholder image for card ${n+1}`,bodyContent:`This is a short description for card number ${n+1}. It provides some context about the image above.`})),u={args:{items:K,modifiers:"cards"},render:e=>({components:{UluScrollSlider:w,UluCard:M},setup(){return{args:e}},template:`
      <UluScrollSlider 
        v-bind="args" 
    ...
    `})},x={args:{...u.args,scrollAmount:450},render:u.render},k={args:{...u.args,controls:!1},render:u.render};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    items: mockItems,
  ...
  render: Default.render
}`,...k.parameters?.docs?.source}}};const ee=["Default","CustomScrollAmount","WithoutControls"];export{x as CustomScrollAmount,u as Default,k as WithoutControls,ee as __namedExportsOrder,Z as default};
