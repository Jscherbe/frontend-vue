import{Q as c,a3 as r,a4 as p,a5 as u,h as d}from"./iframe-B_vWY6zZ.js";import"./preload-helper-BJwshlQW.js";function h(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
