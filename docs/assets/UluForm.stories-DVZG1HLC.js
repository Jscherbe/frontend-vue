import{z as n,U as c,A as m,B as u,C as i}from"./iframe-CpwZzjQD.js";import"./preload-helper-BJwshlQW.js";const g={component:n,tags:["autodocs"],argTypes:{element:{control:"text"},fullWidth:{control:"boolean"},fullWidthSelect:{control:"boolean"},hideLabels:{control:"boolean"},actionsRight:{control:"boolean"}}},e=l=>({components:{UluForm:n,UluFormItem:i,UluFormText:u,UluFormActions:m,UluButton:c},setup(){return{args:l}},template:`
    <UluForm v-bind="args">
      <UluFormItem text>
