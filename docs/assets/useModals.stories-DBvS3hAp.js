import{_ as n}from"./UluButton-DA7pXF4m.js";import{k as s}from"./iframe-DAIrjjun.js";import"./UluAction-B9TxNpKv.js";import"./preload-helper-BJwshlQW.js";const t=()=>{const o=s("uluModals");if(!o)throw new Error("Modals plugin not installed");return o},u={},e={name:"useModals",render:()=>({components:{UluButton:n},setup(){const o=t();return{openDemo:()=>{console.log("This is opening via uluModals composable"),o.open("demo")}}},template:`
