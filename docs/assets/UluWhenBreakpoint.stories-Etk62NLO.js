import{P as B,q as s,c as x,K as k,a0 as A,e as U,f as S,k as w}from"./iframe-B43ONlbJ.js";import"./preload-helper-BJwshlQW.js";const v={__name:"UluWhenBreakpoint",props:{max:String,min:String,only:String},setup(l){const e=l,t=B("uluBreakpointManager"),r=s({}),p=s([]),m=s(!1),T=x(()=>!m.value||["max","min","only"].filter(n=>e[n]).length===0?!1:Object.values(r.value).every(n=>n)),y=o=>{const n=i=>{const a=e[i];if(a){r.value[i]=!1;const d={on:()=>{r.value[i]=!0},off:()=>{r.value[i]=!1}};o.at(a)[i](d),p.value.push({name:a,direction:i,handler:d})}};n("max"),n("min"),n("only"),m.value=!0},f=()=>{t.value&&p.value.forEach(({name:o,direction:n,handler:i})=>{const a=t.value.at(o);if(a)try{a.remove(i,n)}catch(d){console.error(d)}}),p.value=[],r.value={},m.value=!1};return k(t,o=>{o&&!m.value&&y(o)},{immediate:!0}),k([()=>e.max,()=>e.min,()=>e.only],()=>{t.value&&m.value&&(f(),y(t.value))}),A(()=>{f()}),(o,n)=>T.value?U(o.$slots,"default",{key:0}):S("",!0)}};v.__docgenInfo={exportName:"default",displayName:"UluWhenBreakpoint",description:"",tags:{},props:[{name:"max",description:"The maximum breakpoint to show the content at.",type:{name:"string"}},{name:"min",description:"The minimum breakpoint to show the content at.",type:{name:"string"}},{name:"only",description:"Only show the content at this breakpoint.",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/layout/UluWhenBreakpoint.vue"]};const _={component:v,tags:["autodocs"],argTypes:{min:{control:"select",options:["none","small","medium","large"],description:"Show at this breakpoint and above."},max:{control:"select",options:["none","small","medium","large"],description:"Show at this breakpoint and below."},only:{control:"select",options:["none","small","medium","large"],description:"Show only at this breakpoint."}},render:l=>({components:{UluWhenBreakpoint:v},setup(){const e=w("uluBreakpointActive");return{args:l,breakpointActive:e}},template:`
    <div>
...
}`,...g.parameters?.docs?.source}}};const C=["Only","Min","Max","Between","DynamicProps"];export{h as Between,g as DynamicProps,b as Max,u as Min,c as Only,C as __namedExportsOrder,_ as default};
