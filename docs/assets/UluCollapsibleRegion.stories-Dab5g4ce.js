import{U as a}from"./iframe-BEAGWnDg.js";import"./preload-helper-BJwshlQW.js";const i={title:"Components/Collapsible/UluCollapsibleRegion",component:a,tags:["autodocs"],args:{title:"Toggle Collapsible Region",transitionHeight:!0,transitionFades:!0},argTypes:{title:{control:"text"},closeOnEscape:{control:"boolean"},startOpen:{control:"boolean"},transitionHeight:{control:"boolean"},transitionFades:{control:"boolean"},transitionTiming:{control:"text"},transitionDuration:{control:"text"},default:{control:"text",name:"slot: default",description:"The content inside the collapsible region."}},render:o=>({components:{UluCollapsibleRegion:a},setup(){return{args:o}},template:`
