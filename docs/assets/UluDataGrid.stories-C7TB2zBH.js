...
`,T={component:d,tags:["autodocs"]},_=i=>({components:{UluDataGrid:d},setup(){return{args:i}},template:m}),r=_.bind({});r.parameters={docs:{source:{code:m,language:"html",type:"code"}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => ({
  components: {
    UluDataGrid
  },
  setup() {
