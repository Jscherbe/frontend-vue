import{Z as S,$ as U,a0 as P,a1 as _,a2 as C,z as x}from"./iframe-BNGjnuds.js";import{u as T}from"./useFacets-Cvm6u9Vt.js";import{u as A}from"./usePagination-CJVLk1l7.js";import{_ as I}from"./UluPager-DMfWQ5r4.js";import"./preload-helper-BJwshlQW.js";const E={parameters:{chromatic:{disableSnapshot:!0}}},L=e=>{const i=x(e.items),{facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=T(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=A(l,e.itemsPerPage);return{args:e,facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},O=`
...
`,a=["lorem","ipsum","dolor","sit","amet","consectetur","adipiscing","elit","curabitur","vehicula","vitae","sapien","nec","ultricies","mauris","pellentesque","egestas","enim","a","scelerisque"],n=["Red","Blue","Green","Yellow","Purple","Orange","Black","White","Gray","Brown"],m=["Dog","Cat","Lion","Tiger","Bear","Elephant","Giraffe","Zebra","Monkey","Horse"],c=["Apple","Banana","Cherry","Date","Elderberry","Fig","Grape","Honeydew","Kiwi","Lemon"],u=["USA","Canada","Mexico","Brazil","Argentina","UK","France","Germany","Japan","Australia"],p=["Wood","Steel","Plastic","Cotton","Wool","Silk","Leather","Rubber","Glass","Ceramic"];function w(e){const i=[];for(let t=0;t<e;t++){const o=Math.floor(Math.random()*3)+1,s=new Set;for(;s.size<o;)s.add(c[Math.floor(Math.random()*c.length)]);i.push({id:t,title:`Item ${t+1}`,description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae sapien nec ultricies.",facet1:a[Math.floor(Math.random()*a.length)],facet2:a[Math.floor(Math.random()*a.length)],facet3:a[Math.floor(Math.random()*a.length)],color:n[Math.floor(Math.random()*n.length)],animal:m[Math.floor(Math.random()*m.length)],fruit:[...s],country:u[Math.floor(Math.random()*u.length)],material:p[Math.floor(Math.random()*p.length)]})}return i}const k=[{name:"Facet 1",uid:"facet1",open:!1},{name:"Facet 2",uid:"facet2",open:!1},{name:"Facet 3",uid:"facet3",open:!1},{name:"Color",uid:"color",open:!1},{name:"Animal",uid:"animal",open:!1},{name:"Fruit (AND)",uid:"fruit",open:!0,multiple:!0,match:"all"},{name:"Country",uid:"country",open:!1},{name:"Material",uid:"material",open:!1}],r=e=>({components:{UluFacetsFilterLists:C,UluFacetsResults:_,UluFacetsSearch:P,UluFacetsSort:U,UluFacetsSidebarLayout:S,UluPager:I},setup:()=>L(e),template:O});r.args={items:w(2e3),facetFields:k,countMode:"intuitive",searchPlaceholder:"Search 2000 items...",maxVisible:10,itemsPerPage:10,searchOptions:{keys:["title","description","facet1","facet2","facet3","color","animal","fruit","country","material"]}};r.storyName="Performance (Intuitive, 2k items)";r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => ({
  components: {
