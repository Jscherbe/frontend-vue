...
`)].join(`
`));let T=fe((l=d.props)!=null?l:{},b,P),f=Ue(d,T,!0);for(let u in T)u.startsWith("on")&&(f.props||(f.props={}),f.props[u]=T[u]);return f}return Array.isArray(m)&&m.length===1?m[0]:m}return G(s,Object.assign({},b,P),{default:()=>m})}function pe(e){return e.flatMap(t=>t.type===ie?pe(t.children):[t])}function fe(...e){if(e.length===0)return{};if(e.length===1)return e[0];let t={},n={};for(let a of e)for(let r in a)r.startsWith("on")&&typeof a[r]=="function"?(n[r]!=null||(n[r]=[]),n[r].push(a[r])):t[r]=a[r];if(t.disabled||t["aria-disabled"])return Object.assign(t,Object.fromEntries(Object.keys(n).map(a=>[a,void 0])));for(let a in n)Object.assign(t,{[a](r,...o){let l=n[a];for(let s of l){if(r instanceof Event&&r.defaultPrevented)return;s(r,...o)}}});return t}function be(e,t=[]){let n=Object.assign({},e);for(let a of t)a in n&&delete n[a];return n}function Be(e){return e==null?!1:typeof e.type=="string"||typeof e.type=="object"||typeof e.type=="function"}var ve=(e=>(e[e.None=1]="None",e[e.Focusable=2]="Focusable",e[e.Hidden=4]="Hidden",e))(ve||{});let me=N({name:"Hidden",props:{as:{type:[Object,String],default:"div"},features:{type:Number,default:1}},setup(e,{slots:t,attrs:n}){return()=>{var a;let{features:r,...o}=e,l={"aria-hidden":(r&2)===2?!0:(a=o["aria-hidden"])!=null?a:void 0,hidden:(r&4)===4?!0:void 0,style:{position:"fixed",top:1,left:1,width:1,height:0,padding:0,margin:-1,overflow:"hidden",clip:"rect(0, 0, 0, 0)",whiteSpace:"nowrap",borderWidth:"0",...(r&4)===4&&(r&2)!==2&&{display:"none"}}};return L({ourProps:l,theirProps:o,slot:{},attrs:n,slots:t,name:"Hidden"})}}});var I=(e=>(e.Space=" ",e.Enter="Enter",e.Escape="Escape",e.Backspace="Backspace",e.Delete="Delete",e.ArrowLeft="ArrowLeft",e.ArrowUp="ArrowUp",e.ArrowRight="ArrowRight",e.ArrowDown="ArrowDown",e.Home="Home",e.End="End",e.PageUp="PageUp",e.PageDown="PageDown",e.Tab="Tab",e))(I||{});let Ce=N({props:{onFocus:{type:Function,required:!0}},setup(e){let t=S(!0);return()=>t.value?G(me,{as:"button",type:"button",features:ve.Focusable,onFocus(n){n.preventDefault();let a,r=50;function o(){var l;if(r--<=0){a&&cancelAnimationFrame(a);return}if((l=e.onFocus)!=null&&l.call(e)){t.value=!1,cancelAnimationFrame(a);return}a=requestAnimationFrame(o)}a=requestAnimationFrame(o)}}):null}});var Re=(e=>(e[e.Forwards=0]="Forwards",e[e.Backwards=1]="Backwards",e))(Re||{}),He=(e=>(e[e.Less=-1]="Less",e[e.Equal=0]="Equal",e[e.Greater=1]="Greater",e))(He||{});let he=Symbol("TabsContext");function W(e){let t=q(he,null);if(t===null){let n=new Error(`<${e} /> is missing a parent <TabGroup /> component.`);throw Error.captureStackTrace&&Error.captureStackTrace(n,W),n}return t}let J=Symbol("TabsSSRContext"),We=N({name:"TabGroup",emits:{change:e=>!0},props:{as:{type:[Object,String],default:"template"},selectedIndex:{type:[Number],default:null},defaultIndex:{type:[Number],default:0},vertical:{type:[Boolean],default:!1},manual:{type:[Boolean],default:!1}},inheritAttrs:!1,setup(e,{slots:t,attrs:n,emit:a}){var r;let o=S((r=e.selectedIndex)!=null?r:e.defaultIndex),l=S([]),s=S([]),b=g(()=>e.selectedIndex!==null),m=g(()=>b.value?e.selectedIndex:o.value);function P(u){var c;let v=O(d.tabs.value,h),i=O(d.panels.value,h),U=v.filter(y=>{var x;return!((x=h(y))!=null&&x.hasAttribute("disabled"))});if(u<0||u>v.length-1){let y=A(o.value===null?0:Math.sign(u-o.value),{[-1]:()=>1,0:()=>A(Math.sign(u),{[-1]:()=>0,0:()=>0,1:()=>1}),1:()=>0}),x=A(y,{0:()=>v.indexOf(U[0]),1:()=>v.indexOf(U[U.length-1])});x!==-1&&(o.value=x),d.tabs.value=v,d.panels.value=i}else{let y=v.slice(0,u),x=[...v.slice(u),...y].find(K=>U.includes(K));if(!x)return;let _=(c=v.indexOf(x))!=null?c:d.selectedIndex.value;_===-1&&(_=d.selectedIndex.value),o.value=_,d.tabs.value=v,d.panels.value=i}}let d={selectedIndex:g(()=>{var u,c;return(c=(u=o.value)!=null?u:e.defaultIndex)!=null?c:null}),orientation:g(()=>e.vertical?"vertical":"horizontal"),activation:g(()=>e.manual?"manual":"auto"),tabs:l,panels:s,setSelectedIndex(u){m.value!==u&&a("change",u),b.value||P(u)},registerTab(u){var c;if(l.value.includes(u))return;let v=l.value[o.value];if(l.value.push(u),l.value=O(l.value,h),!b.value){let i=(c=l.value.indexOf(v))!=null?c:o.value;i!==-1&&(o.value=i)}},unregisterTab(u){let c=l.value.indexOf(u);c!==-1&&l.value.splice(c,1)},registerPanel(u){s.value.includes(u)||(s.value.push(u),s.value=O(s.value,h))},unregisterPanel(u){let c=s.value.indexOf(u);c!==-1&&s.value.splice(c,1)}};le(he,d);let p=S({tabs:[],panels:[]}),T=S(!1);D(()=>{T.value=!0}),le(J,g(()=>T.value?null:p.value));let f=g(()=>e.selectedIndex);return D(()=>{Pe([f],()=>{var u;return P((u=e.selectedIndex)!=null?u:e.defaultIndex)},{immediate:!0})}),oe(()=>{if(!b.value||m.value==null||d.tabs.value.length<=0)return;let u=O(d.tabs.value,h);u.some((c,v)=>h(d.tabs.value[v])!==h(c))&&d.setSelectedIndex(u.findIndex(c=>h(c)===h(d.tabs.value[m.value])))}),()=>{let u={selectedIndex:o.value};return G(ie,[l.value.length<=0&&G(Ce,{onFocus:()=>{for(let c of l.value){let v=h(c);if(v?.tabIndex===0)return v.focus(),!0}return!1}}),L({theirProps:{...n,...be(e,["selectedIndex","defaultIndex","manual","vertical","onChange"])},ourProps:{},slot:u,slots:t,attrs:n,name:"TabGroup"})])}}}),qe=N({name:"TabList",props:{as:{type:[Object,String],default:"div"}},setup(e,{attrs:t,slots:n}){let a=W("TabList");return()=>{let r={selectedIndex:a.selectedIndex.value},o={role:"tablist","aria-orientation":a.orientation.value};return L({ourProps:o,theirProps:e,slot:r,attrs:t,slots:n,name:"TabList"})}}}),Ye=N({name:"Tab",props:{as:{type:[Object,String],default:"button"},disabled:{type:[Boolean],default:!1},id:{type:String,default:null}},setup(e,{attrs:t,slots:n,expose:a}){var r;let o=(r=e.id)!=null?r:`headlessui-tabs-tab-${ce()}`,l=W("Tab"),s=S(null);a({el:s,$el:s}),D(()=>l.registerTab(s)),de(()=>l.unregisterTab(s));let b=q(J),m=g(()=>{if(b.value){let i=b.value.tabs.indexOf(o);return i===-1?b.value.tabs.push(o)-1:i}return-1}),P=g(()=>{let i=l.tabs.value.indexOf(s);return i===-1?m.value:i}),d=g(()=>P.value===l.selectedIndex.value);function p(i){var U;let y=i();if(y===j.Success&&l.activation.value==="auto"){let x=(U=Oe(s))==null?void 0:U.activeElement,_=l.tabs.value.findIndex(K=>h(K)===x);_!==-1&&l.setSelectedIndex(_)}return y}function T(i){let U=l.tabs.value.map(y=>h(y)).filter(Boolean);if(i.key===I.Space||i.key===I.Enter){i.preventDefault(),i.stopPropagation(),l.setSelectedIndex(P.value);return}switch(i.key){case I.Home:case I.PageUp:return i.preventDefault(),i.stopPropagation(),p(()=>E(U,w.First));case I.End:case I.PageDown:return i.preventDefault(),i.stopPropagation(),p(()=>E(U,w.Last))}if(p(()=>A(l.orientation.value,{vertical(){return i.key===I.ArrowUp?E(U,w.Previous|w.WrapAround):i.key===I.ArrowDown?E(U,w.Next|w.WrapAround):j.Error},horizontal(){return i.key===I.ArrowLeft?E(U,w.Previous|w.WrapAround):i.key===I.ArrowRight?E(U,w.Next|w.WrapAround):j.Error}}))===j.Success)return i.preventDefault()}let f=S(!1);function u(){var i;f.value||(f.value=!0,!e.disabled&&((i=h(s))==null||i.focus({preventScroll:!0}),l.setSelectedIndex(P.value),xe(()=>{f.value=!1})))}function c(i){i.preventDefault()}let v=Ge(g(()=>({as:e.as,type:t.type})),s);return()=>{var i,U;let y={selected:d.value,disabled:(i=e.disabled)!=null?i:!1},{...x}=e,_={ref:s,onKeydown:T,onMousedown:c,onClick:u,id:o,role:"tab",type:v.value,"aria-controls":(U=h(l.panels.value[P.value]))==null?void 0:U.id,"aria-selected":d.value,tabIndex:d.value?0:-1,disabled:e.disabled?!0:void 0};return L({ourProps:_,theirProps:x,slot:y,attrs:t,slots:n,name:"Tab"})}}}),Ve=N({name:"TabPanels",props:{as:{type:[Object,String],default:"div"}},setup(e,{slots:t,attrs:n}){let a=W("TabPanels");return()=>{let r={selectedIndex:a.selectedIndex.value};return L({theirProps:e,ourProps:{},slot:r,attrs:n,slots:t,name:"TabPanels"})}}}),Ke=N({name:"TabPanel",props:{as:{type:[Object,String],default:"div"},static:{type:Boolean,default:!1},unmount:{type:Boolean,default:!0},id:{type:String,default:null},tabIndex:{type:Number,default:0}},setup(e,{attrs:t,slots:n,expose:a}){var r;let o=(r=e.id)!=null?r:`headlessui-tabs-panel-${ce()}`,l=W("TabPanel"),s=S(null);a({el:s,$el:s}),D(()=>l.registerPanel(s)),de(()=>l.unregisterPanel(s));let b=q(J),m=g(()=>{if(b.value){let p=b.value.panels.indexOf(o);return p===-1?b.value.panels.push(o)-1:p}return-1}),P=g(()=>{let p=l.panels.value.indexOf(s);return p===-1?m.value:p}),d=g(()=>P.value===l.selectedIndex.value);return()=>{var p;let T={selected:d.value},{tabIndex:f,...u}=e,c={ref:s,id:o,role:"tabpanel","aria-labelledby":(p=h(l.tabs.value[P.value]))==null?void 0:p.id,tabIndex:d.value?f:-1};return!d.value&&e.unmount&&!e.static?G(me,{as:"span","aria-hidden":!0,...c}):L({ourProps:c,theirProps:u,slot:T,attrs:t,slots:n,features:X.Static|X.RenderStrategy,visible:d.value,name:"TabPanel"})}}});const Q={__name:"UluTab",setup(e){return(t,n)=>(R(),M(C(Ye),null,{default:B(a=>[H(t.$slots,"default",Y(V(a)))]),_:3}))}};Q.__docgenInfo={exportName:"default",displayName:"UluTab",description:"",tags:{},slots:[{name:"default",scoped:!0,bindings:[]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluTab.vue"]};const Z=Object.assign({inheritAttrs:!1},{__name:"UluTabGroup",props:{defaultIndex:Number,vertical:Boolean},setup(e){return(t,n)=>(R(),M(C(We),{defaultIndex:e.defaultIndex,vertical:e.vertical},{default:B(a=>[ge("div",{class:ye(["tabs",{"tabs--vertical":e.vertical}])},[H(t.$slots,"default",Y(V(a)))],2)]),_:3},8,["defaultIndex","vertical"]))}});Z.__docgenInfo={exportName:"default",displayName:"UluTabGroup",description:"",tags:{},props:[{name:"defaultIndex",description:"Active tab index by default",type:{name:"number"}},{name:"vertical",description:"Whether or not to use vertical layout",type:{name:"boolean"}}],slots:[{name:"default",scoped:!0,bindings:[]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluTabGroup.vue"]};const ee={__name:"UluTabList",setup(e){return(t,n)=>(R(),M(C(qe),{class:"tabs__tablist"},{default:B(()=>[H(t.$slots,"default")]),_:3}))}};ee.__docgenInfo={exportName:"default",displayName:"UluTabList",description:"",tags:{},slots:[{name:"default"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluTabList.vue"]};const te={__name:"UluTabPanel",setup(e){return(t,n)=>(R(),M(C(Ke),null,{default:B(a=>[H(t.$slots,"default",Y(V(a)))]),_:3}))}};te.__docgenInfo={exportName:"default",displayName:"UluTabPanel",description:"",tags:{},slots:[{name:"default",scoped:!0,bindings:[]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluTabPanel.vue"]};const ne={__name:"UluTabPanels",setup(e){return(t,n)=>(R(),M(C(Ve),null,{default:B(a=>[H(t.$slots,"default",Y(V(a)))]),_:3}))}};ne.__docgenInfo={exportName:"default",displayName:"UluTabPanels",description:"",tags:{},slots:[{name:"default",scoped:!0,bindings:[]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluTabPanels.vue"]};const Qe={component:Z,subcomponents:{UluTabList:ee,UluTab:Q,UluTabPanels:ne,UluTabPanel:te},tags:["autodocs"]},ae=e=>({components:{UluTabGroup:Z,UluTabList:ee,UluTab:Q,UluTabPanels:ne,UluTabPanel:te},setup(){return{args:e}},template:`
  ...
  \`
})`,...k.parameters?.docs?.source}}};const Ze=["Default","Vertical","DefaultIndex"];export{F as Default,k as DefaultIndex,$ as Vertical,Ze as __namedExportsOrder,Qe as default};
