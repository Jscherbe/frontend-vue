import{aD as w,P as h,ac as x,ad as f,b5 as T,D as B,L as S,aH as _}from"./iframe-BAda3xFs.js";import"./preload-helper-BJwshlQW.js";const b={__name:"UluWhenBreakpoint",props:{max:String,min:String,only:String},setup(c){const o=c,a=w("uluBreakpointManager"),r=h({}),d=h([]),s=h(!1),k=x(()=>!s.value||["max","min","only"].filter(e=>o[e]).length===0?!1:Object.values(r.value).every(e=>e)),g=n=>{const e=t=>{const u=o[t];if(u){r.value[t]=!1;const v={on:()=>{r.value[t]=!0},off:()=>{r.value[t]=!1}};n.at(u)[t](v),d.value.push({name:u,direction:t,handler:v})}};e("max"),e("min"),e("only"),s.value=!0},y=()=>{a&&d.value.forEach(({name:n,direction:e,handler:t})=>{a.at(n).remove(t,e)}),d.value=[],r.value={},s.value=!1};return f(a,n=>{n&&!s.value&&g(n)},{immediate:!0}),f([()=>o.max,()=>o.min,()=>o.only],()=>{a&&s.value&&(y(),g(a))}),T(()=>{y()}),(n,e)=>k.value?B(n.$slots,"default",{key:0}):S("",!0)}};b.__docgenInfo={exportName:"default",displayName:"UluWhenBreakpoint",description:"",tags:{},props:[{name:"max",description:"The maximum breakpoint to show the content at.",type:{name:"string"}},{name:"min",description:"The minimum breakpoint to show the content at.",type:{name:"string"}},{name:"only",description:"Only show the content at this breakpoint.",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/joe/Projects/Personal/Github/frontend-vue/lib/components/layout/UluWhenBreakpoint.vue"]};const M={component:b,tags:["autodocs"],argTypes:{min:{control:"select",options:["none","small","medium","large"],description:"Show at this breakpoint and above."},max:{control:"select",options:["none","small","medium","large"],description:"Show at this breakpoint and below."},only:{control:"select",options:["none","small","medium","large"],description:"Show only at this breakpoint."}},render:c=>({components:{UluWhenBreakpoint:b},setup(){const o=_("uluBreakpointActive");return{args:c,breakpointActive:o}},template:`
    <div>
