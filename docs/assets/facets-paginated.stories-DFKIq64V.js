import{Z as F,$ as b,a0 as y,a1 as f,a2 as S,z as U}from"./iframe-CeblUMpV.js";import{u as v}from"./useFacets-DvQ_opJf.js";import{u as x}from"./usePagination-4Kp8eKQj.js";import{_ as P}from"./UluPager-SAozQa-Q.js";import{m as _}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";const j={parameters:{chromatic:{disableSnapshot:!0}}},L=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],I=e=>{const s=U(e.items),{facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m}=v(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType}),{currentPage:p,totalPages:d,paginatedItems:u,pagerItems:g,pagerEllipses:h}=x(a,e.itemsPerPage);return{args:e,facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m,currentPage:p,totalPages:d,paginatedItems:u,pagerItems:g,pagerEllipses:h}},t=e=>({components:{UluFacetsFilterLists:S,UluFacetsResults:f,UluFacetsSearch:y,UluFacetsSort:b,UluFacetsSidebarLayout:F,UluPager:P},setup:()=>I(e),template:`
