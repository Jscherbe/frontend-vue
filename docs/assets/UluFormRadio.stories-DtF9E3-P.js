import{L as t,D as a,I as n}from"./iframe-sn1yWKrl.js";import"./preload-helper-BJwshlQW.js";const d={component:t,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"text"},value:{control:"text"},name:{control:"text"},required:{control:"boolean"}}},e={render:l=>({components:{UluFormItem:a,UluFormRadio:t},setup(){const r=n("option2");return{args:l,selectedValue:r}},template:`
