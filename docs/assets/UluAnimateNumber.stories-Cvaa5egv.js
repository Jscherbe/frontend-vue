import{ao as o,U as m,z as s}from"./iframe-7nmooSbU.js";import"./preload-helper-BJwshlQW.js";const U={component:o,tags:["autodocs"],argTypes:{value:{control:{type:"number",min:0,max:1e3,step:1},description:"The target number to animate to."}},args:{value:0}},t={render:u=>({components:{UluAnimateNumber:o,UluButton:m},setup(){const e=s(u.value);return{animatedValue:e,increment:()=>{e.value+=100},decrement:()=>{e.value-=50},reset:()=>{e.value=0}}},template:`
      <div>
