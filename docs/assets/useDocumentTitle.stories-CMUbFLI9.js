import{W as g,X as y,Y as b,j as x,l as r,O as h,M,Z as w,_ as R,L as D,E as k,D as C,c as H,u as E,C as f,Q as U,G as A}from"./fontawesome-DyrJdE5N.js";import{c as j}from"./iframe-DFeB4tIX.js";import{g as I}from"./router-B1jYtMfx.js";import"./preload-helper-BJwshlQW.js";function p(t,e,n){typeof t==="function"&&(!n||n!=="titleTemplate"&&!(n[0]==="o"&&n[1]==="n"))&&(t=t());let o;if(e&&(o=e(n,t)),Array.isArray(o))return o.map(s=>p(s,e));if(o?.constructor===Object){const s={};for(const i of Object.keys(o))s[i]=p(o[i],e,i);return s}return o}const O=(t,e)=>y(e)?g(e):e,P="usehead";function S(){if(b()){const t=x(P);if(!t)throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.");return t}throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.")}function _(t,e={}){const n=e.head||S();return n.ssr?n.push(t||{},e):z(n,t,e)}function z(t,e,n={}){const a=r(!1);let o;return h(()=>{const i=a.value?{}:p(e,O);o?o.patch(i):o=t.push(i,n)}),D()&&(M(()=>{o.dispose()}),w(()=>{a.value=!0}),R(()=>{a.value=!1})),o}const m=C({});function T(t={}){const{title:e,titleTemplate:n="%s",useRoute:a=j,useHead:o=_}=t,s=a(),i=s.path;if(e!==void 0){h(()=>{m[i]=E(e)}),k(()=>{delete m[i]});return}const l=H(()=>{const u=m[s.path],v=I(s,s),d=u||v;return d?n.replace("%s",d):"App"});o({title:l})}const $={title:"Composables/useDocumentTitle"},c={name:"Interactive Demo",render:()=>({setup(){const t=r(""),e=l=>{f(l.title,u=>{t.value=u},{immediate:!0})},n=r({path:"/story-route",meta:{title:"Default Meta Title"}}),a=()=>n.value;T({titleTemplate:"Test Title: %s",useRoute:a,useHead:e});const o=r(""),s=r("Default Meta Title"),i=U({setup:()=>(T({title:o,useRoute:a}),()=>A("div",{style:"font-size: 12px; color: #666; margin-top: 10px;"}," "))});return f(s,l=>{n.value={path:"/story-route",meta:{title:l}}}),{componentTitle:o,routeMetaTitle:s,headTitle:t,MockPageComponent:i}},template:`
      <div>
