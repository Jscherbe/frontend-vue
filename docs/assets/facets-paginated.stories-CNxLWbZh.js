import{a0 as F,a1 as b,a2 as y,a3 as f,Y as S,z as U}from"./iframe-DpYtvPQB.js";import{u as v,m as x}from"./_mock-data-BskTtaXy.js";import{u as P}from"./usePagination-DJQN3ucW.js";import{_}from"./UluPager-C54Aldqg.js";import"./preload-helper-BJwshlQW.js";const $={parameters:{chromatic:{disableSnapshot:!0}}},L=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],I=e=>{const s=U(e.items),{facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m}=v(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType}),{currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}=P(a,e.itemsPerPage);return{args:e,facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m,currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}},t=e=>({components:{UluFacetsFilterLists:S,UluFacetsResults:f,UluFacetsSearch:y,UluFacetsSort:b,UluFacetsSidebarLayout:F,UluPager:_},setup:()=>I(e),template:`
  ...
  `});t.args={facetFields:L,items:x,searchPlaceholder:"Search articles...",maxVisible:5,itemsPerPage:5};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => ({
  components: {
