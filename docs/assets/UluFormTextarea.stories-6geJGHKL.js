import{_ as s}from"./UluFormTextarea-BbT5muSA.js";import{_ as l}from"./UluFormItem-CFoKD81h.js";import{q as u}from"./iframe-Cct7deJN.js";import"./UluFormRequiredChar-DEP24tJt.js";import"./preload-helper-BJwshlQW.js";const g={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
