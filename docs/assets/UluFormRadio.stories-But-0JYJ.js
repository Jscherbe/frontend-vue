import{_ as t}from"./UluFormRadio-DLue_aq_.js";import{_ as a}from"./UluFormItem-CETv8uMs.js";import{s as m}from"./iframe-Dn9nvJ2t.js";import"./UluFormRequiredChar-CJe587Tb.js";import"./preload-helper-BJwshlQW.js";const p={component:t,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"text"},value:{control:"text"},name:{control:"text"},required:{control:"boolean"}}},e={render:l=>({components:{UluFormItem:a,UluFormRadio:t},setup(){const r=m("option2");return{args:l,selectedValue:r}},template:`
