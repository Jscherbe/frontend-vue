import{g as d}from"./iframe-DFeB4tIX.js";import{D as l}from"./fontawesome-DyrJdE5N.js";import"./preload-helper-BJwshlQW.js";const m={template:`
  ...
  `,setup(){const t=l({success:"fas fa-check-circle",failure:["fas","times-circle"]}),{getIconDefinition:e,getIconProps:r,getClassesFromDefinition:s}=d(),n=e("success"),c=e("failure"),i=r("fas fa-home"),a=r(["fas","user"]),p=s("fas fa-cog"),f=s(["fas","heart"]),g=s({icon:["fas","star"]});return{defaultIcons:t,successIconDef:n,failureIconDef:c,propsFromString:i,propsFromArray:a,classesFromString:p,classesFromArray:f,classesFromObject:g}}},y={title:"Composables/useIcon",component:m},o={};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"{}",...o.parameters?.docs?.source}}};const D=["Default"];export{o as Default,D as __namedExportsOrder,y as default};
