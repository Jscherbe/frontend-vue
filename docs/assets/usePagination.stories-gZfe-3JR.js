import{$ as p,P as u}from"./iframe-CfzwUndu.js";import{u as g}from"./usePagination-DSr9u14I.js";import"./preload-helper-BJwshlQW.js";const h={parameters:{chromatic:{disableSnapshot:!0},notes:"This story demonstrates the `usePagination` composable. It requires a `vue-router` instance to be provided to the application, as it interacts with the route query to manage the page state. If the pager links do not work, it is because the router is not configured in Storybook."}},l={components:{UluPager:p},props:{itemsPerPage:{type:Number,default:10}},template:`
    <div>
