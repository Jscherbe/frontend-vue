import{h as c,v as h,T as w,e as _,k as p,a as x,d as y,r as d,b as O,w as u,U,a0 as b,o as g,l as C,_ as k}from"./iframe-DLKis_3v.js";import{u as P}from"./useWindowResize-Pc80EPRg.js";import"./preload-helper-BJwshlQW.js";const T={class:"layout-flex-baseline"},I={class:"type-word-break"},a={__name:"UluOverflowPopover",props:{triggerIcon:String},setup(s){const{resizing:f,onResizeEnd:m}=P(),n=c(null),l=c(!1),i=()=>{b(()=>{const e=n.value;l.value=e.offsetWidth<e.scrollWidth})},v=m(i);return h(i),w(v),(e,z)=>(g(),_("div",T,[p("div",{class:"type-truncate",ref_key:"text",ref:n},[d(e.$slots,"default")],512),l.value&&!O(f)?(g(),x(U,{key:0,triggerAlt:"Show Full Text",size:"large"},{trigger:u(()=>[C(k,{icon:s.triggerIcon||"type:ellipsis"},null,8,["icon"])]),default:u(()=>[p("div",I,[d(e.$slots,"default")])]),_:3})):y("",!0)]))}};a.__docgenInfo={exportName:"default",displayName:"UluOverflowPopover",description:"",tags:{},props:[{name:"triggerIcon",description:"Default icon for overflow popover trigger",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluOverflowPopover.vue"]};const $={title:"Components/Collapsible/UluOverflowPopover",component:a,decorators:[()=>({template:`
