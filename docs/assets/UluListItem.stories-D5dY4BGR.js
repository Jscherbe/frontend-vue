import{_ as r}from"./UluListItem-YkDM8nhX.js";import{p as a,c as o}from"./iframe-Dn9nvJ2t.js";import"./preload-helper-BJwshlQW.js";const i={tags:["autodocs"],component:r,decorators:[e=>({setup(){a("uluListContext",o(()=>({classes:{item:"ulu-injected-item-class"},itemElement:"li"})))},template:'<ul class="ulu-list-demo-container"><story /></ul>'})],argTypes:{classes:{control:"object"},element:{control:"text"}}},s={render:e=>({components:{UluListItem:r},setup(){return{args:e}},template:`
