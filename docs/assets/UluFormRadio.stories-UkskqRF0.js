import{_ as t}from"./UluFormRadio-DERot48J.js";import{_ as a}from"./UluFormItem--dTSgxla.js";import{l as m}from"./iframe-Dmbn_XAG.js";import"./UluFormRequiredChar-EC8L9s2V.js";import"./preload-helper-BJwshlQW.js";const p={component:t,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"text"},value:{control:"text"},name:{control:"text"},required:{control:"boolean"}}},e={render:l=>({components:{UluFormItem:a,UluFormRadio:t},setup(){const r=m("option2");return{args:l,selectedValue:r}},template:`
