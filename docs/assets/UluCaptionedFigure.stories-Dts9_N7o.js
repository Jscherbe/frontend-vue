import{c as g,d,e as u,f,n as h,u as U,o as l,i as v,t as b}from"./fontawesome-DyrJdE5N.js";import{u as y}from"./iframe-DFeB4tIX.js";import{_ as c}from"./UluImage-82esh8i6.js";import"./preload-helper-BJwshlQW.js";const C={key:0,class:"captioned-figure__caption"},r={__name:"UluCaptionedFigure",props:{caption:{type:String,default:""},position:String,modifiers:[String,Array]},setup(e){const o=e,{resolvedModifiers:m}=y({props:o,baseClass:"captioned-figure",internal:g(()=>({traditional:!o.position,[o.position]:o.position}))});return(s,F)=>(l(),d("figure",{class:h(["captioned-figure",U(m)])},[u(s.$slots,"default"),e.caption||s.$slots.caption?(l(),d("figcaption",C,[u(s.$slots,"caption",{},()=>[v(b(e.caption),1)])])):f("",!0)],2))}};r.__docgenInfo={exportName:"default",displayName:"UluCaptionedFigure",description:"",tags:{},props:[{name:"caption",description:"The text content for the caption.",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"position",description:"Positioning (e.g., 'bottom', 'center', 'right') else defaults to traditional",type:{name:"string"}},{name:"modifiers",description:"Modifiers for styling and positioning (e.g., 'bottom', 'center', 'right', 'traditional').",type:{name:"string|array"}}],slots:[{name:"default"},{name:"caption"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/elements/UluCaptionedFigure.vue"]};const _={component:r,tags:["autodocs"],argTypes:{caption:{control:"text"},modifiers:{control:"text"}}},p=e=>({components:{UluCaptionedFigure:r,UluImage:c},setup(){return{args:e}},template:`
  ...
  \`
})`,...i.parameters?.docs?.source}}};const w=["Default","CenteredOverlay","Traditional","WithSlot"];export{n as CenteredOverlay,t as Default,a as Traditional,i as WithSlot,w as __namedExportsOrder,_ as default};
