import{V as g,W as a,X as l,Y as r,Z as i,$ as v}from"./iframe-DuX-PKOB.js";import{u as b,m as f}from"./_mock-data-C3ORATOj.js";import"./preload-helper-BJwshlQW.js";const _={},U=[{name:"Category",uid:"category",open:!0},{name:"Author",uid:"author",open:!0}],n=e=>{const c=v(e.items),{facets:o,searchValue:d,selectedSort:m,sortTypes:p,displayItems:u,selectedFacets:h,clearFilters:F,handleFacetChange:y}=b(c,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType});return{args:e,facets:o,searchValue:d,selectedSort:m,sortTypes:p,displayItems:u,selectedFacets:h,clearFilters:F,handleFacetChange:y}},t=e=>({components:{UluFacetsFilters:i,UluFacetsResults:r,UluFacetsSearch:l,UluFacetsSort:a,UluFacetsSidebarLayout:g},setup:()=>n(e),template:`
