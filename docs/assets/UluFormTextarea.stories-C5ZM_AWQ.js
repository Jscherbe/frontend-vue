import{_ as s}from"./UluFormTextarea-V7FAGDow.js";import{_ as l}from"./UluFormItem-DW5hXPMH.js";import{ref as u}from"vue";import"./iframe-VeyoJg8x.js";import"./preload-helper-BJwshlQW.js";import"vue-router";import"@floating-ui/vue";import"@ulu/utils/templating.js";import"@ulu/utils/browser/dom.js";import"@ulu/frontend";import"./UluFormRequiredChar-BTQ7f0nP.js";const v={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
  ...
  args: {}
}`,...o.parameters?.docs?.source}}};const I=["Default","Required","CustomRequiredLabel","LabelHidden","VModel"];export{t as CustomRequiredLabel,e as Default,n as LabelHidden,a as Required,o as VModel,I as __namedExportsOrder,v as default};
