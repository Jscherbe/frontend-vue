import{y as s,z as l}from"./iframe-DEXCoylX.js";import"./preload-helper-BJwshlQW.js";const r={component:s,argTypes:{legend:{control:"text"},type:{control:"radio",options:["checkbox","radio"]}}},e={render:o=>({components:{UluSelectableMenu:s},setup(){const t=l(["option-2"]);return{args:o,options:[{label:"Option 1",value:"option-1"},{label:"Option 2",value:"option-2"},{label:"Option 3",value:"option-3"}],selections:t}},template:`
      <UluSelectableMenu
        v-model="selections"
        :options="options"
