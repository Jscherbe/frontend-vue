import{az as c,bc as r,bd as p,be as u,H as d}from"./iframe-9MqUug2p.js";import"./preload-helper-BJwshlQW.js";function b(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
       composable provides a directive-free, programmatic way to control the global tooltip.`}}}},n=t=>({setup(){const{showTooltip:e,hideTooltip:i,tooltipState:s}=b(),o=d(null);return{args:t,buttonEl:o,show:()=>{o.value&&e(o.value,{content:`This tooltip is controlled by a composable!
