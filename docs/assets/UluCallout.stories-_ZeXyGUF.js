import{u as i,d as c,e as d,n as p,l as m,o as g}from"./iframe-ssSLPBZB.js";import"./preload-helper-BJwshlQW.js";const l={__name:"UluCallout",props:{fullHeight:Boolean,modifiers:[String,Array]},setup(a){const n=a,{resolvedModifiers:r}=i({props:n,baseClass:"callout"});return(u,f)=>(g(),c("div",{class:p(["callout",[m(r),{"full-height":a.fullHeight}]])},[d(u.$slots,"default")],2))}};l.__docgenInfo={exportName:"default",displayName:"UluCallout",description:"",tags:{},props:[{name:"fullHeight",description:"Add full height utility class",type:{name:"boolean"}},{name:"modifiers",description:`Class modifiers (ie. 'transparent', 'secondary', etc)
