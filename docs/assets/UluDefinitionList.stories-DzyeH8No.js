import{c as x,u as T,d as g,f as w,F as A,x as C,n as s,q as k,o as b,b as D,e as h,j as y,t as S}from"./iframe-g5ukAtQs.js";import"./preload-helper-BJwshlQW.js";const u={__name:"UluDefinitionList",props:{items:Array,classes:{type:Object,default:()=>({})},modifiers:[String,Array],inline:Boolean,inlineAll:Boolean,table:Boolean,separated:Boolean,separatedFirst:Boolean,separatedLast:Boolean,compact:Boolean},setup(e){const t=e,L=x(()=>({inline:t.inline,"inline-all":t.inlineAll,table:t.table,separated:t.separated,"separated-first":t.separatedFirst,"separated-last":t.separatedLast,compact:t.compact})),{resolvedModifiers:U}=T({props:t,internal:L,baseClass:"definition-list"});return(v,B)=>e.items?.length?(b(),g("dl",{key:0,class:s(["definition-list",[k(U),e.classes.list]])},[(b(!0),g(A,null,C(e.items,(n,f)=>(b(),g("div",{key:f,class:s(e.classes.item)},[D("dt",{class:s(e.classes.term)},[h(v.$slots,"term",{item:n,index:f},()=>[y(S(n.term),1)])],2),D("dd",{class:s(e.classes.description)},[h(v.$slots,"description",{item:n,index:f},()=>[y(S(n.description),1)])],2)],2))),128))],2)):w("",!0)}};u.__docgenInfo={exportName:"default",displayName:"UluDefinitionList",description:"",tags:{},props:[{name:"items",description:`Array of term, and description (props in object)
