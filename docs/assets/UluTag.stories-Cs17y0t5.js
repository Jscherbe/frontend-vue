import{w as l}from"./iframe-DJ9yAl8J.js";import"./preload-helper-BJwshlQW.js";const u={component:l,args:{text:"Tag Label"},argTypes:{text:{control:"text"},icon:{control:"text"},small:{control:"boolean"},modifiers:{control:"text"}}},r={},a={args:{text:"Icon Tag",icon:"fas fa-tag"}},s={args:{text:"Small Tag",small:!0}},i=n=>({components:{UluTag:l},setup(){return{args:n,modifiers:["secondary","tertiary","success","danger","warning","info","light","dark"],capitalize:o=>o.charAt(0).toUpperCase()+o.slice(1)}},template:`
