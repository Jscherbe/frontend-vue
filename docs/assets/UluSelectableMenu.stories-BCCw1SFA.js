import{q as l}from"./iframe-CYbrjJdn.js";import{_ as s}from"./UluSelectableMenu-wK81uwpE.js";import"./preload-helper-BJwshlQW.js";const c={component:s,argTypes:{legend:{control:"text"},type:{control:"radio",options:["checkbox","radio"]}}},e={render:o=>({components:{UluSelectableMenu:s},setup(){const t=l(["option-2"]);return{args:o,options:[{label:"Option 1",value:"option-1"},{label:"Option 2",value:"option-2"},{label:"Option 3",value:"option-3"}],selections:t}},template:`
      <UluSelectableMenu
        v-model="selections"
        :options="options"
...
}`,...n.parameters?.docs?.source}}};const u=["Checkboxes","Radios"];export{e as Checkboxes,n as Radios,u as __namedExportsOrder,c as default};
