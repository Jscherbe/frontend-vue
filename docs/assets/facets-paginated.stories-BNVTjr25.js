import{V as F,W as y,X as b,Y as f,Z as S,$ as U}from"./iframe-DuX-PKOB.js";import{u as v,m as x}from"./_mock-data-C3ORATOj.js";import{u as P}from"./usePagination-7IRQkq5m.js";import{_}from"./UluPager-CXE7DBUJ.js";import"./preload-helper-BJwshlQW.js";const $={title:"Systems/Facets/Paginated",parameters:{chromatic:{disableSnapshot:!0}}},I=[{name:"Category",uid:"category",open:!0},{name:"Author",uid:"author",open:!0}],T=e=>{const s=U(e.items),{facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m}=v(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType}),{currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}=P(a,e.itemsPerPage);return{args:e,facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m,currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}},t=e=>({components:{UluFacetsFilters:S,UluFacetsResults:f,UluFacetsSearch:b,UluFacetsSort:y,UluFacetsSidebarLayout:F,UluPager:_},setup:()=>T(e),template:`
  ...
  `});t.args={facetFields:I,items:x,searchPlaceholder:"Search articles...",maxVisible:5,itemsPerPage:5};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => ({
  components: {
    UluFacetsFilters,
    UluFacetsResults,
    UluFacetsSearch,
  ...
  \`
})`,...t.parameters?.docs?.source}}};const j=["SidebarLayout"];export{t as SidebarLayout,j as __namedExportsOrder,$ as default};
