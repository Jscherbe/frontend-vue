import{ai as g,aj as y,ak as b,k as x,s as r,a5 as h,W as w,al as M,am as R,a0 as D,J as k,S as C,N as H,c as U,l as E,K as f,a4 as A,U as j}from"./iframe-DAIrjjun.js";import{g as I}from"./router-B1jYtMfx.js";import"./preload-helper-BJwshlQW.js";function p(t,e,n){typeof t==="function"&&(!n||n!=="titleTemplate"&&!(n[0]==="o"&&n[1]==="n"))&&(t=t());let o;if(e&&(o=e(n,t)),Array.isArray(o))return o.map(s=>p(s,e));if(o?.constructor===Object){const s={};for(const i of Object.keys(o))s[i]=p(o[i],e,i);return s}return o}const S=(t,e)=>y(e)?g(e):e,O="usehead";function P(){if(b()){const t=x(O);if(!t)throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.");return t}throw new Error("useHead() was called without provide context, ensure you call it through the setup() function.")}function z(t,e={}){const n=e.head||P();return n.ssr?n.push(t||{},e):_(n,t,e)}function _(t,e,n={}){const a=r(!1);let o;return h(()=>{const i=a.value?{}:p(e,S);o?o.patch(i):o=t.push(i,n)}),D()&&(w(()=>{o.dispose()}),M(()=>{a.value=!0}),R(()=>{a.value=!1})),o}const m=H({});function T(t={}){const{title:e,titleTemplate:n="%s",useRoute:a=k,useHead:o=z}=t,s=a(),i=s.path;if(e!==void 0){h(()=>{m[i]=E(e)}),C(()=>{delete m[i]});return}const l=U(()=>{const u=m[s.path],v=I(s,s),d=u||v;return d?n.replace("%s",d):"App"});o({title:l})}const W={title:"Composables/useDocumentTitle"},c={name:"Interactive Demo",render:()=>({setup(){const t=r(""),e=l=>{f(l.title,u=>{t.value=u},{immediate:!0})},n=r({path:"/story-route",meta:{title:"Default Meta Title"}}),a=()=>n.value;T({titleTemplate:"Test Title: %s",useRoute:a,useHead:e});const o=r(""),s=r("Default Meta Title"),i=A({setup:()=>(T({title:o,useRoute:a}),()=>j("div",{style:"font-size: 12px; color: #666; margin-top: 10px;"}," "))});return f(s,l=>{n.value={path:"/story-route",meta:{title:l}}}),{componentTitle:o,routeMetaTitle:s,headTitle:t,MockPageComponent:i}},template:`
      <div>
...
}`,...c.parameters?.docs?.source}}};const $=["InteractiveDemo"];export{c as InteractiveDemo,$ as __namedExportsOrder,W as default};
