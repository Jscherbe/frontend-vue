...
Takes the value and type ('amount', 'deficit', 'total') as input and should return a string.`,type:{name:"func"},defaultValue:{func:!0,value:"(value, type) => value"}},{name:"amountInHeader",description:"Will put the amount only in header (there is a headerValue slot it you want to format)",type:{name:"boolean"}}],slots:[{name:"label"},{name:"valueAmount",scoped:!0,bindings:[{name:"value",title:"binding"}]},{name:"icon"},{name:"valueDeficit",scoped:!0,bindings:[{name:"value",title:"binding"}]},{name:"valueTotal",scoped:!0,bindings:[{name:"value",title:"binding"}]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/visualizations/UluProgressBar.vue"]};const _={component:I,tags:["autodocs"],argTypes:{amount:{control:{type:"range",min:0,max:100,step:1}},total:{control:{type:"number"}},deficit:{control:{type:"range",min:0,max:100,step:1}},labelElement:{control:"text"},noValues:{control:"boolean"},amountInHeader:{control:"boolean"},formatValue:{table:{disable:!0}},classes:{table:{disable:!0}}}},n={args:{label:"Default Progress",amount:50,total:100}},m={args:{...n.args,label:"Progress with Deficit",amount:60,deficit:20}},g={args:{...n.args,label:"Small Progress",amount:75,small:!0}},p={args:{...n.args,label:"Positive Style",amount:80,positive:!0}},b={args:{...n.args,label:"Negative Style",amount:25,negative:!0}},v={render:e=>({components:{UluProgressBar:I,UluIcon:H},setup(){return{args:e}},template:`
    ...
    `}),args:{...m.args,label:"With Custom Value Slots"}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...B.parameters?.docs?.source}}};const ee=["Default","WithDeficit","Small","Positive","Negative","WithIcon","Loader","Indeterminate","AmountInHeader","NoValues","FormattedValues","CustomLabel","CustomValueSlots"];export{h as AmountInHeader,S as CustomLabel,B as CustomValueSlots,n as Default,P as FormattedValues,y as Indeterminate,f as Loader,b as Negative,V as NoValues,p as Positive,g as Small,m as WithDeficit,v as WithIcon,ee as __namedExportsOrder,_ as default};
