import{X as F,Y as b,Z as y,$ as f,a0 as S,a1 as U}from"./iframe-B7NcqnH3.js";import{u as v,m as x}from"./_mock-data-DSnEbg3I.js";import{u as P}from"./usePagination-DvtciuGh.js";import{_}from"./UluPager-Bl67jmdA.js";import"./preload-helper-BJwshlQW.js";const $={parameters:{chromatic:{disableSnapshot:!0}}},I=[{name:"Category",uid:"category",open:!0},{name:"Author",uid:"author",open:!0}],T=e=>{const s=U(e.items),{facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m}=v(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType}),{currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}=P(a,e.itemsPerPage);return{args:e,facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m,currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}},t=e=>({components:{UluFacetsFilters:S,UluFacetsResults:f,UluFacetsSearch:y,UluFacetsSort:b,UluFacetsSidebarLayout:F,UluPager:_},setup:()=>T(e),template:`
