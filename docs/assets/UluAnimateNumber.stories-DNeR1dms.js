import{O as o,a as m,P as s}from"./iframe-vwPr47zg.js";import"./preload-helper-BJwshlQW.js";const U={title:"Components/Visualizations/UluAnimateNumber",component:o,tags:["autodocs"],argTypes:{value:{control:{type:"number",min:0,max:1e3,step:1},description:"The target number to animate to."}},args:{value:0}},t={render:u=>({components:{UluAnimateNumber:o,UluButton:m},setup(){const e=s(u.value);return{animatedValue:e,increment:()=>{e.value+=100},decrement:()=>{e.value-=50},reset:()=>{e.value=0}}},template:`
      <div>
    ...
    `}),args:{value:123}},n={render:t.render,args:{value:98765}},r={render:t.render,args:{value:-500}},a={render:u=>({components:{UluAnimateNumber:o,UluButton:m},setup(){const e=s(u.value),l=new Intl.NumberFormat("en-US",{style:"currency",currency:"USD"});return{animatedValue:e,formatter:l}},template:`
      <div>
