import{_ as m}from"./UluFormText-C9_yomfV.js";import{_ as l}from"./UluFormItem-DW5hXPMH.js";import{ref as u}from"vue";import"./iframe-VeyoJg8x.js";import"./preload-helper-BJwshlQW.js";import"vue-router";import"@floating-ui/vue";import"@ulu/utils/templating.js";import"@ulu/utils/browser/dom.js";import"@ulu/frontend";import"./UluFormRequiredChar-BTQ7f0nP.js";const v={component:m,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the text input."},modelValue:{control:"text",description:"The value of the text input (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormText:m},setup(){return{args:r}},template:`
