import{X as p,H as u}from"./iframe-Bgp5iAQV.js";import{u as g}from"./usePagination-C2ZZkBfg.js";import"./preload-helper-BJwshlQW.js";const h={parameters:{chromatic:{disableSnapshot:!0},notes:"This story demonstrates the `usePagination` composable. It requires a `vue-router` instance to be provided to the application, as it interacts with the route query to manage the page state. If the pager links do not work, it is because the router is not configured in Storybook."}},l={components:{UluPager:p},props:{itemsPerPage:{type:Number,default:10}},template:`
    <div>
