import{g as U,_ as v,d as l,f as p,b as k,F as S,y as h,n as s,h as d,o as n,a as I,e as u,w as j,j as b,t as g,v as C}from"./iframe-BuaZgQzp.js";import"./preload-helper-BJwshlQW.js";const _={name:"UluBreadcrumb",components:{UluIcon:v},props:{items:{type:Array,default:()=>[]},separatorIcon:String,classes:{type:Object,default:()=>({nav:"breadcrumb",list:"breadcrumb__list",item:"breadcrumb__item",link:"breadcrumb__link",current:"breadcrumb__current",separator:"breadcrumb__separator"})}}};function x(a,N,e,V,P,w){const B=d("router-link"),y=d("UluIcon");return e.items.length?(n(),l("nav",{key:0,class:s(e.classes.nav),"aria-label":"Breadcrumb"},[k("ol",{class:s(e.classes.list)},[(n(!0),l(S,null,h(e.items,(r,i)=>(n(),l("li",{key:i,class:s(e.classes.item)},[r.current?(n(),l("span",{key:1,class:s(r.current)},[u(a.$slots,"default",{item:r},()=>[b(g(r.title),1)])],2)):(n(),I(B,{key:0,to:r.to,class:s(e.classes.link),"aria-current":r.current?"page":null},{default:j(()=>[u(a.$slots,"default",{item:r},()=>[b(g(r.title),1)])]),_:2},1032,["to","class","aria-current"])),i<e.items.length-1?u(a.$slots,"separator",{key:2},()=>[C(y,{class:s(e.classes.separator),icon:e.separatorIcon||"type:pathSeparator"},null,8,["class","icon"])]):p("",!0)],2))),128))],2)],2)):p("",!0)}const m=U(_,[["render",x]]);_.__docgenInfo={displayName:"UluBreadcrumb",description:`Breadcrumb trail component
