...
`,G={component:d,tags:["autodocs"]},U=i=>({components:{UluDataGrid:d},setup(){return{args:i}},template:m}),r=U.bind({});r.parameters={docs:{source:{code:m,language:"html",type:"code"}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => ({
  components: {
    UluDataGrid
  },
  setup() {
...
})`,...r.parameters?.docs?.source}}};const b=["DefaultExample"];export{r as DefaultExample,b as __namedExportsOrder,G as default};
