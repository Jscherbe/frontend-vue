import{al as w,z as h,V as g,b0 as T,a_ as v,aZ as f,aK as F,aH as x}from"./iframe-BJ7lEAgf.js";import"./preload-helper-BJwshlQW.js";function _(t){const n=w(f),l=w(v);t.content||console.warn("Missing content for 'useTooltipFollow' tooltip",t);let s;const o=h(0),e=h(0),i=g(()=>({getBoundingClientRect(){return{width:0,height:0,x:o.value,y:e.value,top:e.value,left:o.value,right:o.value,bottom:e.value}}})),p=l?l.popover:T.popover,d=l?l.tooltip:T.tooltip,u={...{...p,...d},content:t.content,inline:!1,onReady({update:c}){s=c}};return{x:o,y:e,show(){n.show(i.value,u)},hide(){n.state.trigger===i.value&&n.hide()},update(c){o.value=c.x,e.value=c.y,s&&s()}}}const m={__name:"TestTooltipFollow",setup(t){const{x:n,y:l,show:s,hide:o,update:e}=_({content:g(()=>`x: ${Math.round(n.value)}, y: ${Math.round(l.value)}`)}),i=a=>{p(a),s()},p=({clientX:a,clientY:u})=>{e({x:a,y:u})},d=()=>{o()};return(a,u)=>(x(),F("div",{onPointerenter:i,onPointermove:p,onPointerleave:d,style:{background:"lightblue",width:"500px",height:"500px",display:"flex","align-items":"center","justify-content":"center"}}," Cursor Test ",32))}};m.__docgenInfo={exportName:"default",displayName:"TestTooltipFollow",description:"",tags:{},sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/plugins/popovers/tests/TestTooltipFollow.vue"]};const j={component:{TestTooltipFollow:m},tags:["autodocs"],parameters:{docs:{source:{language:"html",code:`
<template>
  <div 
...
<\/script>
        `}}}},y=t=>({components:{TestTooltipFollow:m},setup(){return{args:t}},template:`
    <TestTooltipFollow/>
