import{az as c,bc as r,bd as p,be as u,H as d}from"./iframe-DR32bCDK.js";import"./preload-helper-BJwshlQW.js";function b(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
