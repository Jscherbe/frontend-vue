import{B as a}from"./iframe-CmsGqXpF.js";import"./preload-helper-BJwshlQW.js";const i={component:a,tags:["autodocs"]},e={args:{title:"My Title",icon:"type:info"}},n={args:{title:"This has a user set icon",icon:"fas fa-circle-check"}},t={args:{...e.args,icon:"type:info"}},r={render:s=>({components:{UluTitleRail:a},setup(){return{args:s}},template:`
