import{d as u,b as p,t as m,o as v,l}from"./fontawesome-DyrJdE5N.js";import{a as g}from"./iframe-DFeB4tIX.js";import"./preload-helper-BJwshlQW.js";const h={style:{"text-align":"center"}},C={style:{margin:"0 0 0.5rem 0","font-size":"1rem"}},c={__name:"StoryTooltipComponent",props:{title:String},setup(t){return(n,e)=>(v(),u("div",h,[p("h4",C,m(t.title||"no title"),1),e[0]||(e[0]=p("p",{style:{margin:"0","font-size":"0.875rem"}},"This is a Vue component being rendered inside a tooltip.",-1))]))}};c.__docgenInfo={exportName:"default",displayName:"StoryTooltipComponent",description:"",tags:{},props:[{name:"title",type:{name:"string"}}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/plugins/popovers/tests/StoryTooltipComponent.vue"]};const x={tags:["autodocs"],argTypes:{content:{control:"text",description:"The text to display in the tooltip."}}},o=t=>({setup(){return{args:t}},template:`
  ...
  \`
})`,...r.parameters?.docs?.source}}};const M=["Basic","ReactiveContent","HtmlContent","ComponentContent","InModal"];export{o as Basic,i as ComponentContent,s as HtmlContent,r as InModal,a as ReactiveContent,M as __namedExportsOrder,x as default};
