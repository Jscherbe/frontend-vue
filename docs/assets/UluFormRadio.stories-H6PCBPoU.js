import{K as t,C as a,H as n}from"./iframe-Bgp5iAQV.js";import"./preload-helper-BJwshlQW.js";const d={component:t,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"text"},value:{control:"text"},name:{control:"text"},required:{control:"boolean"}}},e={render:l=>({components:{UluFormItem:a,UluFormRadio:t},setup(){const r=n("option2");return{args:l,selectedValue:r}},template:`
