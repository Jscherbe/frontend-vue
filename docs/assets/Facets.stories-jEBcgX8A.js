import{l as _}from"./iframe-BAOMv0fj.js";import{_ as u,u as I}from"./UluFacetsFilterAccordions-IeWjW35x.js";import{_ as m,a as p,b as d,c as F}from"./UluFacetsSort-BEyzx8XB.js";import{_ as g}from"./UluFacetsActiveFilters-BOooAFtL.js";import{m as x}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";import"./UluSelectableMenu-BZj9fHJC.js";import"./UluAccordion-9RrFQkmC.js";import"./UluCollapsible-BYE5M9gS.js";const O={},n=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],l=e=>{const i=_(e.items),{facets:f,searchValue:y,selectedSort:U,sortTypes:S,displayItems:v,selectedFacets:A,clearFilters:C,handleFacetChange:b}=I(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions});return{args:e,facets:f,searchValue:y,selectedSort:U,sortTypes:S,displayItems:v,selectedFacets:A,clearFilters:C,handleFacetChange:b}},h=`
...
`,c={items:x,searchPlaceholder:"Search articles...",maxVisible:5},t=e=>({components:{UluFacetsFilterAccordions:u,UluFacetsResults:F,UluFacetsSearch:d,UluFacetsSort:p,UluFacetsSidebarLayout:m,UluFacetsActiveFilters:g},setup:()=>l(e),template:h});t.args={...c,facetFields:n,countMode:"none"};const a=e=>({...t(e),setup:()=>l(e)});a.args={...c,facetFields:n,countMode:"simple"};a.storyName="Counts (Simple)";const s=e=>({...t(e),setup:()=>l(e)});s.args={...c,facetFields:n,countMode:"intuitive"};s.storyName="Counts (Intuitive)";const r=e=>({...t(e),setup:()=>l(e)});r.args={...c,facetFields:[{name:"Category",uid:"category",open:!0,multiple:!0,match:"all"},{name:"Author",uid:"author",open:!0}],countMode:"intuitive"};r.storyName="Counts (Intuitive) with AND logic";const o=e=>({components:{UluFacetsFilterAccordions:u,UluFacetsResults:F,UluFacetsSearch:d,UluFacetsSort:p,UluFacetsSidebarLayout:m,UluFacetsActiveFilters:g},setup:()=>{const i=l(e);return i.handleFacetChange({groupUid:"category",facetUid:"cat2",selected:!0}),i.handleFacetChange({groupUid:"author",facetUid:"jane-doe",selected:!0}),i},template:h});o.args={...c,facetFields:n,countMode:"intuitive"};o.storyName="With Initial Filters";t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => ({
  ...
  template: storyTemplate
})`,...o.parameters?.docs?.source}}};const P=["Default","CountsSimple","CountsIntuitive","CountsIntuitiveAndLogic","WithInitialFilters"];export{s as CountsIntuitive,r as CountsIntuitiveAndLogic,a as CountsSimple,t as Default,o as WithInitialFilters,P as __namedExportsOrder,O as default};
