import{_ as s}from"./UluFormTextarea-Cbs91XKA.js";import{_ as l}from"./UluFormItem-CVvYgr70.js";import{l as u}from"./iframe-8M2bENpm.js";import"./UluFormRequiredChar-T5kVe-0k.js";import"./preload-helper-BJwshlQW.js";const g={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
