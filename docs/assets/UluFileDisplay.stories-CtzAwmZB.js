import{x as i}from"./iframe-CeblUMpV.js";import"./preload-helper-BJwshlQW.js";const f={component:i,tags:["autodocs"]},n=new File([new ArrayBuffer(12345)],"example-document.pdf",{type:"application/pdf"}),e={args:{file:n}},m=new File([new ArrayBuffer(500)],"small-file.txt",{type:"text/plain"}),r={args:{file:m}},c=new File([new ArrayBuffer(5e6)],"large-video.mp4",{type:"video/mp4"}),a={args:{file:c}},s={args:{file:n,noFileSize:!0}},l={args:{file:n,icon:"star"}},o={render:t=>({components:{UluFileDisplay:i},setup(){return{args:t}},template:`
