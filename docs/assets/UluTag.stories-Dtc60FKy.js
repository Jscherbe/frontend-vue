import{_ as i}from"./UluTag-B9yt4WHV.js";import"./iframe-Db2mi-K0.js";import"./preload-helper-BJwshlQW.js";const f={component:i,args:{text:"Tag Label",counter:!1},argTypes:{text:{control:"text"},icon:{control:"text"},size:{control:"text"},type:{control:"text"},modifiers:{control:"text"},counter:{control:"boolean"}}},r={},a={args:{text:"Icon Tag",icon:"type:file"}},s={args:{text:"Small Tag",size:"small"}},c=l=>({components:{UluTag:i},setup(){return{args:l,modifiers:["secondary","tertiary","success","danger","warning","info","light","dark"],capitalize:n=>n.charAt(0).toUpperCase()+n.slice(1)}},template:`
