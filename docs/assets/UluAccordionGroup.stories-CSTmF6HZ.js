import{a as r,b as s}from"./iframe-CZEnXdIU.js";import"./preload-helper-BJwshlQW.js";const m={component:r,tags:["autodocs"]},i=[{title:"First Item",content:"This is the content for the first item.",isOpen:!0},{title:"Second Item",content:"This is the content for the second item."},{title:"Third Item",content:"This is the content for the third item."}],e={args:{items:i}},t={args:{items:[{title:"First Custom",content:{summary:"Summary one",details:"Details one"}},{title:"Second Custom",content:{summary:"Summary two",details:"Details two"}}]},render:o=>({components:{UluAccordionGroup:r},setup(){return{args:o}},template:`
