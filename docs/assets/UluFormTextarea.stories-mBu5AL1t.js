import{_ as s}from"./UluFormTextarea-BNrqxFUu.js";import{_ as l}from"./UluFormItem-8KvZzm_k.js";import{l as u}from"./iframe-g5ukAtQs.js";import"./UluFormRequiredChar-_GZWC4Hk.js";import"./preload-helper-BJwshlQW.js";const g={component:s,tags:["autodocs"],argTypes:{label:{control:"text",description:"The label for the textarea."},modelValue:{control:"text",description:"The value of the textarea (for v-model)."},labelHidden:{control:"boolean",description:"If true, the label will be visually hidden."},required:{control:"boolean",description:"If true, the field will be required."}}},e={render:r=>({components:{UluFormItem:l,UluFormTextarea:s},setup(){return{args:r}},template:`
