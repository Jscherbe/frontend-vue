import{a0 as S,a3 as U,a4 as P,a5 as A,a6 as C,a7 as _,I as x}from"./iframe-Cr3nWxIL.js";import{u as I}from"./useFacets-BB7RX5aA.js";import{u as T}from"./usePagination-BCITJhh1.js";import"./preload-helper-BJwshlQW.js";const j={parameters:{chromatic:{disableSnapshot:!0}}},O=e=>{const i=x(e.items),{facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=I(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=T(l,e.itemsPerPage);return{args:e,facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},w=`
...
`,a=["lorem","ipsum","dolor","sit","amet","consectetur","adipiscing","elit","curabitur","vehicula","vitae","sapien","nec","ultricies","mauris","pellentesque","egestas","enim","a","scelerisque"],n=["Red","Blue","Green","Yellow","Purple","Orange","Black","White","Gray","Brown"],c=["Dog","Cat","Lion","Tiger","Bear","Elephant","Giraffe","Zebra","Monkey","Horse"],m=["Apple","Banana","Cherry","Date","Elderberry","Fig","Grape","Honeydew","Kiwi","Lemon"],u=["USA","Canada","Mexico","Brazil","Argentina","UK","France","Germany","Japan","Australia"],p=["Wood","Steel","Plastic","Cotton","Wool","Silk","Leather","Rubber","Glass","Ceramic"];function L(e){const i=[];for(let t=0;t<e;t++){const o=Math.floor(Math.random()*3)+1,s=new Set;for(;s.size<o;)s.add(m[Math.floor(Math.random()*m.length)]);i.push({id:t,title:`Item ${t+1}`,description:"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur vitae sapien nec ultricies.",facet1:a[Math.floor(Math.random()*a.length)],facet2:a[Math.floor(Math.random()*a.length)],facet3:a[Math.floor(Math.random()*a.length)],color:n[Math.floor(Math.random()*n.length)],animal:c[Math.floor(Math.random()*c.length)],fruit:[...s],country:u[Math.floor(Math.random()*u.length)],material:p[Math.floor(Math.random()*p.length)]})}return i}const k=[{name:"Facet 1",uid:"facet1",open:!1},{name:"Facet 2",uid:"facet2",open:!1},{name:"Facet 3",uid:"facet3",open:!1},{name:"Color",uid:"color",open:!1},{name:"Animal",uid:"animal",open:!1},{name:"Fruit (AND)",uid:"fruit",open:!0,multiple:!0,match:"all"},{name:"Country",uid:"country",open:!1},{name:"Material",uid:"material",open:!1}],r=e=>({components:{UluFacetsFilterAccordions:_,UluFacetsResults:C,UluFacetsSearch:A,UluFacetsSort:P,UluFacetsSidebarLayout:U,UluPager:S},setup:()=>O(e),template:w});r.args={items:L(2e3),facetFields:k,countMode:"intuitive",searchPlaceholder:"Search 2000 items...",maxVisible:10,itemsPerPage:10,searchOptions:{keys:["title","description","facet1","facet2","facet3","color","animal","fruit","country","material"]}};r.storyName="Performance (Intuitive, 2k items)";r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => ({
  components: {
...
})`,...r.parameters?.docs?.source}}};const E=["PerformanceTestIntuitive"];export{r as PerformanceTestIntuitive,E as __namedExportsOrder,j as default};
