import{q as a}from"./iframe-DFeB4tIX.js";import{j as i}from"./fontawesome-DyrJdE5N.js";import{_ as r}from"./UluButton-zu_C2qC9.js";import"./preload-helper-BJwshlQW.js";import"./UluAction-CSWkOuPE.js";import"./props-DEaRQ31f.js";const n=[{label:"Retry",click:()=>{}}],c=[{title:"Title",date:"10m ago",description:"This is the description"},{description:"This is the description",actions:n},{description:"Database error",class:"is-danger background-context",icon:"triangle-exclamation",actions:n},{title:"Brief Title",description:"This is a warning, lorem ipsum et depsi",class:"is-warning background-context",icon:"triangle-exclamation",actions:[...n,{label:"Cancel",click:()=>{}}]},{class:"is-info background-context",description:"Lorem ipsum et depsi anu",icon:"circle-info"},{class:"is-success background-context",description:"File Saved!",icon:"check"}];function l(){c.forEach((t,o)=>{setTimeout(()=>a.add(t),1500*o)})}const d=()=>{const t=i("uluToast");if(!t)throw new Error("Toast plugin not installed");return t},b={},u=t=>({components:{UluButton:r},setup(){const o=d();return{delayToasts:l,showPersistentToast:()=>{console.log("fired"),console.log(o),o.add({description:"Database error",class:"is-danger background-context",icon:"triangle-exclamation",duration:!1,actions:[{label:"Retry",click:(m,e)=>{o.remove(e.uid)}}]})},...t}},template:`
  ...
  \`
})`,...s.parameters?.docs?.source}}};const w=["Default"];export{s as Default,w as __namedExportsOrder,b as default};
