import{_ as r}from"./UluCollapsible-DCepuLz-.js";import"./iframe-BrHxbdoU.js";import"./preload-helper-BJwshlQW.js";const p={component:r,tags:["autodocs"],args:{triggerText:"Toggle Collapsible Region",animate:!0},argTypes:{triggerText:{control:"text"},closeOnEscape:{control:"boolean"},startOpen:{control:"boolean"},animate:{control:"boolean"},default:{control:"text",name:"slot: default",description:"The content inside the collapsible region."}},render:n=>({components:{UluCollapsible:r},setup(){return{args:n}},template:`
