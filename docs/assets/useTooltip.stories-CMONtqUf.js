import{Q as c,a4 as r,a5 as p,a6 as u,h as d}from"./iframe-B3CzaRfi.js";import"./preload-helper-BJwshlQW.js";function h(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
