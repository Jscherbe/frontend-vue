import{computed as p,createBlock as h,openBlock as d,resolveDynamicComponent as v,normalizeStyle as L,normalizeClass as g,withCtx as U,createElementBlock as b,Fragment as S,renderList as O,renderSlot as I,createTextVNode as T,toDisplayString as x}from"vue";const l={__name:"UluList",props:{items:Array,classes:{type:Object,default:()=>({})},ordered:Boolean,unordered:Boolean,lines:Boolean,compact:Boolean,forceOrdered:Boolean,start:String,reversed:Boolean,listStyleType:String},setup(e){const i=e,c=p(()=>i.ordered||i.forceOrdered),y=p(()=>c.value?"ol":"ul");return(f,k)=>(d(),h(v(y.value),{class:g([{"list-ordered":e.ordered,"list-unordered":e.unordered,"list-lines":e.lines,"list-compact":e.compact},e.classes.list]),style:L({listStyleType:e.listStyleType}),reversed:c.value?e.reversed:null,start:e.start},{default:U(()=>[(d(!0),b(S,null,O(e.items,(m,u)=>(d(),b("li",{key:u,class:g(e.classes.listItem)},[I(f.$slots,"default",{item:m,index:u},()=>[T(x(m),1)])],2))),128))]),_:3},8,["class","style","reversed","start"]))}};l.__docgenInfo={exportName:"default",displayName:"UluList",description:"",tags:{},props:[{name:"items",description:"Array of list items, output as is or use slot to template the item",type:{name:"array"}},{name:"classes",description:`Classes object (keys are list and listItem to be applied to <ul> and <li>)
...
}`,...a.parameters?.docs?.source}}};const z=["Unordered","Ordered","OrderedReversed","OrderedStartValue","LinesList","CustomItemSlot"];export{a as CustomItemSlot,o as LinesList,r as Ordered,s as OrderedReversed,n as OrderedStartValue,t as Unordered,z as __namedExportsOrder,j as default};
