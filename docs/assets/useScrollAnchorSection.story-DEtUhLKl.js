import{I as n}from"./jsx-runtime-kXkYf3tv.js";import{useMDXComponents as o}from"./index-DIzwWG-n.js";import{r as c}from"./index-vwjNkSeb.js";import"./iframe-Dmbn_XAG.js";import"./preload-helper-BJwshlQW.js";function i(t){const e={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...o(),...t.components};return n(c.Fragment,{children:[n(e.h1,{id:"usescrollanchorsection",children:"useScrollAnchorSection"}),`
...
`,n(e.p,{children:["This composable works in conjunction with the ",n(e.code,{children:"UluScrollAnchors"})," component. When a component using ",n(e.code,{children:"useScrollAnchorSection"})," is mounted within ",n(e.code,{children:"UluScrollAnchors"}),", it automatically registers itself. ",n(e.code,{children:"UluScrollAnchors"})," then tracks its visibility and updates the ",n(e.code,{children:"isActive"})," state."]})]})}function a(t={}){const{wrapper:e}={...o(),...t.components};return e?n(e,{...t,children:n(i,{...t})}):i(t)}const p=[];export{p as __namedExportsOrder,a as default};
