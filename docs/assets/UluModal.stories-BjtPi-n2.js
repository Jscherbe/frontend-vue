import{G as m,H as g,U as h,I as M}from"./iframe-h65IHHsm.js";import"./preload-helper-BJwshlQW.js";const U={component:m,tags:["autodocs"]},e=p=>({components:{UluModal:m,UluButton:h,UluPlaceholderText:g},setup(){const u=M(!1);return{args:p,isModalOpen:u}},template:`
    <div>
...
}`,...d.parameters?.docs?.source}}};const S=["Default","NoTeleport","PositionLeft","PositionRight","PositionLeftResizer","PositionRightResizer","PositionCenterResize","NoPreventScroll","PreventScrollNoPreventScrollShift","ContentAbove"];export{d as ContentAbove,t as Default,i as NoPreventScroll,o as NoTeleport,a as PositionCenterResize,l as PositionLeft,r as PositionLeftResizer,n as PositionRight,s as PositionRightResizer,c as PreventScrollNoPreventScrollShift,S as __namedExportsOrder,U as default};
