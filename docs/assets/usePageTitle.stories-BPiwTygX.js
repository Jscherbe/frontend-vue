import{ap as u,a1 as t,aq as d,ar as a,a4 as p,as as m,at as v}from"./iframe-dhuyN9hJ.js";import"./preload-helper-BJwshlQW.js";const c=()=>({path:"/our-story-route"}),C={title:"Composables/usePageTitle",component:{template:"<div>See individual stories for demonstrations.</div>"}},i={name:"1. Setting a static title",render:()=>({setup(){u("A Static Title",{useRoute:c});const e=t("");return d(()=>{e.value=a("/our-story-route")}),{observedTitle:e}},template:`
      <div>
