import{_ as i}from"./UluTag-Cz4Bxh16.js";import"./iframe-fc0isZdR.js";import"./preload-helper-BJwshlQW.js";const f={component:i,args:{text:"Tag Label",counter:!1},argTypes:{text:{control:"text"},icon:{control:"text"},size:{control:"text"},type:{control:"text"},modifiers:{control:"text"},counter:{control:"boolean"}}},r={},a={args:{text:"Icon Tag",icon:"type:file"}},s={args:{text:"Small Tag",size:"small"}},c=l=>({components:{UluTag:i},setup(){return{args:l,modifiers:["secondary","tertiary","success","danger","warning","info","light","dark"],capitalize:n=>n.charAt(0).toUpperCase()+n.slice(1)}},template:`
...
}`,...o.parameters?.docs?.source}}};const x=["Default","WithIcon","Small","AllModifiers","SmallModifiers","WithCounter"];export{e as AllModifiers,r as Default,s as Small,t as SmallModifiers,o as WithCounter,a as WithIcon,x as __namedExportsOrder,f as default};
