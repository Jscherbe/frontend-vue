import{z as f,W as h,aK as m,aH as c,aL as g,aM as y,aG as _,aI as U,aN as v,aJ as S,aO as A,_ as G}from"./iframe-BJ7lEAgf.js";import"./preload-helper-BJwshlQW.js";const O={class:"accordion-group"},l={__name:"UluAccordionGroup",props:{items:{type:Array,default:()=>[]}},setup(i){const u=i,o=f([]);h(()=>u.items,t=>{o.value=t.map(n=>({...n,isOpen:n.isOpen||!1}))},{immediate:!0,deep:!0});function p(t,n){n?o.value.forEach((e,s)=>{e.isOpen=s===t}):o.value[t].isOpen=!1}return(t,n)=>(c(),m("div",O,[(c(!0),m(g,null,y(o.value,(e,s)=>(c(),_(G,{key:s,"model-value":e.isOpen,"onUpdate:modelValue":d=>p(s,d),"trigger-text":e.title,classes:e.classes},{default:U(()=>[v(t.$slots,"item",{item:e,index:s},()=>[S(A(e.content),1)])]),_:2},1032,["model-value","onUpdate:modelValue","trigger-text","classes"]))),128))]))}};l.__docgenInfo={exportName:"default",displayName:"UluAccordionGroup",description:"",tags:{},props:[{name:"items",description:`Array of items to render as accordions.
