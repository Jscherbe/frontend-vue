import{I as d,J as l}from"./iframe-ULHYlDKO.js";import"./preload-helper-BJwshlQW.js";const u={template:`
  ...
  `,setup(){const t=d({success:"fas fa-check-circle",failure:["fas","times-circle"]}),{getIconDefinition:e,getIconProps:r,getClassesFromDefinition:s}=l(),n=e("success"),c=e("failure"),i=r("fas fa-home"),a=r(["fas","user"]),p=s("fas fa-cog"),f=s(["fas","heart"]),g=s({icon:["fas","star"]});return{defaultIcons:t,successIconDef:n,failureIconDef:c,propsFromString:i,propsFromArray:a,classesFromString:p,classesFromArray:f,classesFromObject:g}}},h={title:"Composables/useIcon",component:u},o={};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:"{}",...o.parameters?.docs?.source}}};const y=["Default"];export{o as Default,y as __namedExportsOrder,h as default};
