import{H as s,aB as g,aC as m,a9 as z}from"./iframe-Bgp5iAQV.js";import"./preload-helper-BJwshlQW.js";const R={template:`
  ...
  `,setup(){const{resizing:r,onResizeStart:a,onResizeEnd:i}=g(),e=s("Ready"),o=s(0),n=s(0),d=()=>{e.value="Started resizing...",o.value++},u=()=>{e.value="Finished resizing (debounced 300ms)",n.value++},c=a(d),l=i(u);m(()=>{c(),l(),console.log("Resize listeners cleaned up.")});const p=z(()=>e.value.startsWith("Started")?"blue":e.value.startsWith("Finished")?"green":"black");return{resizing:r,status:e,statusColor:p,startCount:o,endCount:n}}},b={title:"Composables/useWindowResize",component:R},t={};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:"{}",...t.parameters?.docs?.source}}};const f=["Default"];export{t as Default,f as __namedExportsOrder,b as default};
