import{c as p,a as h,f as v,w as L,p as U,n as g,r as S,o as d,d as b,F as O,g as I,e as T,j as k,t as x}from"./iframe-DXNgQF3n.js";import"./preload-helper-BJwshlQW.js";const l={__name:"UluList",props:{items:Array,classes:{type:Object,default:()=>({})},ordered:Boolean,unordered:Boolean,lines:Boolean,compact:Boolean,forceOrdered:Boolean,start:String,reversed:Boolean,listStyleType:String},setup(e){const i=e,c=p(()=>i.ordered||i.forceOrdered),y=p(()=>c.value?"ol":"ul");return(f,B)=>e.items?.length?(d(),h(S(y.value),{key:0,class:g([{"list-ordered":e.ordered,"list-unordered":e.unordered,"list-lines":e.lines,"list-compact":e.compact},e.classes.list]),style:U({listStyleType:e.listStyleType}),reversed:c.value?e.reversed:null,start:e.start},{default:L(()=>[(d(!0),b(O,null,I(e.items,(m,u)=>(d(),b("li",{key:u,class:g(e.classes.listItem)},[T(f.$slots,"default",{item:m,index:u},()=>[k(x(m),1)])],2))),128))]),_:3},8,["class","style","reversed","start"])):v("",!0)}};l.__docgenInfo={exportName:"default",displayName:"UluList",description:"",tags:{},props:[{name:"items",description:"Array of list items, output as is or use slot to template the item",type:{name:"array"}},{name:"classes",description:`Classes object (keys are list and listItem to be applied to <ul> and <li>)
