import{ax as M,ay as f,az as P,aA as C,aB as B,aC as b,aD as v,aE as S,ao as $,aF as y}from"./iframe-X51LRpgI.js";import"./preload-helper-BJwshlQW.js";const n=[{path:"/",meta:{title:"Home",weight:-10},children:[{path:"",component:{}}]},{path:"/about",meta:{title:"About Us"},children:[{path:"",component:{}}]},{path:"/products",meta:{title:"Products",weight:10},children:[{path:"",meta:{title:"All Products"},component:{}},{path:"new",meta:{title:"New Product"},component:{}},{path:"featured",meta:{title:"Featured",weight:-5},component:{}}]},{path:"/products/:id",meta:{title:e=>`Product #${e.params.id}`},component:{}},{path:"/contact",meta:{title:"Contact",weight:20},component:{}},{path:"/admin",meta:{title:"Admin",breadcrumb:!1},component:{}}],r=e=>$("pre",{style:"font-size: 12px;"},JSON.stringify(e,null,2)),A={component:{template:"<div>See individual stories for router util demonstrations.</div>"}},a={name:"createBaseMenu",render:()=>{const e=M(n);return r(e)}},o={name:"createBaseMenu (with children)",render:()=>{const e=M(n,{includeChildren:!0});return r(e)}},c={name:"flattenMenu",render:()=>{const e=M(n,{includeChildren:!0}),t=f(e);return r({originalNestedMenu:e,flattenedMenu:t})}},s={name:"createSectionMenu",render:()=>{const e=P(n,"/products");return r(e)}},u={name:"isStaticRoute / isStaticBaseRoute",render:()=>{const e=n.map(t=>({path:t.path,isStatic:B(t),isStaticBase:C(t)}));return r(e)}},h={path:"/products/new",matched:[{path:"/products",meta:{title:"Products",weight:10},children:n.find(e=>e.path==="/products").children},{path:"/products/new",meta:{title:"New Product"},component:{}}]},i={name:"$getParentRoute",render:()=>{const e=b(h),t=b(h,!0);return r({"current route path":h.path,"immediateParent path":e.path,"deepestParent path":t.path})}},m={name:"$createSectionMenu",render:()=>{const e=v(h);return r(e)}},d={name:"$createBreadcrumb",render:()=>{const t=S({path:"/products/new",params:{},matched:[{path:"/",meta:{title:"Home"}},{path:"/products",meta:{title:"Products"}},{path:"/products/new",meta:{title:"New Product"}}]}),l={path:"/products/42",params:{id:"42"},matched:[{path:"/",meta:{title:"Home"}},{path:"/products",meta:{title:"Products"}},{path:"/products/:id",meta:n.find(k=>k.path==="/products/:id").meta}]},g=S(l),R={path:"/admin",params:{},matched:[{path:"/",meta:{title:"Home"}},{path:"/admin",meta:n.find(k=>k.path==="/admin").meta}]},w=S(R);return r({"Scenario 1: Simple Nested Route (/products/new)":t,"Scenario 2: Dynamic Title (/products/42)":g,"Scenario 3: Excluded Route (/admin)":w})}},p={name:"nativeLinkRouter",argTypes:{onRoute:{action:"route-pushed"}},render:e=>({template:`
            <div>
        ...
        `,setup(){return{handleClick:l=>{y({push:R=>e.onRoute(R)},l)}}}})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  name: "createBaseMenu",
  render: () => {
