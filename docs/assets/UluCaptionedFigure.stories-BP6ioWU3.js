import{u as g,c as f,e as d,r as u,d as h,n as U,b,o as l,f as v,t as y}from"./iframe-dqyhXnFM.js";import{_ as c}from"./UluImage-9im7PgF8.js";import"./preload-helper-BJwshlQW.js";const C={key:0,class:"captioned-figure__caption"},r={__name:"UluCaptionedFigure",props:{caption:{type:String,default:""},position:String,modifiers:[String,Array]},setup(e){const o=e,{resolvedModifiers:m}=g({props:o,baseClass:"captioned-figure",internal:f(()=>({traditional:!o.position,[o.position]:o.position}))});return(s,F)=>(l(),d("figure",{class:U(["captioned-figure",b(m)])},[u(s.$slots,"default"),e.caption||s.$slots.caption?(l(),d("figcaption",C,[u(s.$slots,"caption",{},()=>[v(y(e.caption),1)])])):h("",!0)],2))}};r.__docgenInfo={exportName:"default",displayName:"UluCaptionedFigure",description:"",tags:{},props:[{name:"caption",description:"The text content for the caption.",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"position",description:"Positioning (e.g., 'bottom', 'center', 'right') else defaults to traditional",type:{name:"string"}},{name:"modifiers",description:"Modifiers for styling and positioning (e.g., 'bottom', 'center', 'right', 'traditional').",type:{name:"string|array"}}],slots:[{name:"default"},{name:"caption"}],sourceFiles:["/Users/joe/Projects/Personal/Github/frontend-vue/lib/components/elements/UluCaptionedFigure.vue"]};const S={component:r,tags:["autodocs"],argTypes:{caption:{control:"text"},modifiers:{control:"text"}}},p=e=>({components:{UluCaptionedFigure:r,UluImage:c},setup(){return{args:e}},template:`
