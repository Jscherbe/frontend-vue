import{l as c,Q as h,M as w,d as _,b as p,a as x,f as y,e as d,q as O,w as u,N as b,S as U,o as f,v as C,_ as P}from"./iframe-ULHYlDKO.js";import{u as k}from"./useWindowResize-DvOvVMmH.js";import"./preload-helper-BJwshlQW.js";const I={class:"layout-flex-baseline"},S={class:"type-word-break"},a={__name:"UluOverflowPopover",props:{triggerIcon:String},setup(s){const{resizing:g,onResizeEnd:m}=k(),n=c(null),l=c(!1),i=()=>{U(()=>{const e=n.value;l.value=e.offsetWidth<e.scrollWidth})},v=m(i);return h(i),w(v),(e,T)=>(f(),_("div",I,[p("div",{class:"type-truncate",ref_key:"text",ref:n},[d(e.$slots,"default")],512),l.value&&!O(g)?(f(),x(b,{key:0,triggerAlt:"Show Full Text",size:"large"},{trigger:u(()=>[C(P,{icon:s.triggerIcon||"type:ellipsis"},null,8,["icon"])]),default:u(()=>[p("div",S,[d(e.$slots,"default")])]),_:3})):y("",!0)]))}};a.__docgenInfo={exportName:"default",displayName:"UluOverflowPopover",description:"",tags:{},props:[{name:"triggerIcon",description:"Default icon for overflow popover trigger",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluOverflowPopover.vue"]};const $={title:"Components/Collapsible/UluOverflowPopover",component:a,decorators:[()=>({template:`
