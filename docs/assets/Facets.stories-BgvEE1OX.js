import{Y as u,Z as m,$ as p,a0 as d,a1 as F,a2 as g,z as _}from"./iframe-xnBg5cKp.js";import{u as I}from"./useFacets-BJNuKqsc.js";import{m as L}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";const D={},c=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],l=e=>{const i=_(e.items),{facets:f,searchValue:y,selectedSort:U,sortTypes:S,displayItems:v,selectedFacets:C,clearFilters:b,handleFacetChange:A}=I(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions});return{args:e,facets:f,searchValue:y,selectedSort:U,sortTypes:S,displayItems:v,selectedFacets:C,clearFilters:b,handleFacetChange:A}},h=`
...
`,n={items:L,searchPlaceholder:"Search articles...",maxVisible:5},t=e=>({components:{UluFacetsFilterLists:g,UluFacetsResults:F,UluFacetsSearch:d,UluFacetsSort:p,UluFacetsSidebarLayout:m,UluFacetsActiveFilters:u},setup:()=>l(e),template:h});t.args={...n,facetFields:c,countMode:"none"};const a=e=>({...t(e),setup:()=>l(e)});a.args={...n,facetFields:c,countMode:"simple"};a.storyName="Counts (Simple)";const s=e=>({...t(e),setup:()=>l(e)});s.args={...n,facetFields:c,countMode:"intuitive"};s.storyName="Counts (Intuitive)";const r=e=>({...t(e),setup:()=>l(e)});r.args={...n,facetFields:[{name:"Category",uid:"category",open:!0,multiple:!0,match:"all"},{name:"Author",uid:"author",open:!0}],countMode:"intuitive"};r.storyName="Counts (Intuitive) with AND logic";const o=e=>({components:{UluFacetsFilterLists:g,UluFacetsResults:F,UluFacetsSearch:d,UluFacetsSort:p,UluFacetsSidebarLayout:m,UluFacetsActiveFilters:u},setup:()=>{const i=l(e);return i.handleFacetChange({groupUid:"category",facetUid:"cat2",selected:!0}),i.handleFacetChange({groupUid:"author",facetUid:"jane-doe",selected:!0}),i},template:h});o.args={...n,facetFields:c,countMode:"intuitive"};o.storyName="With Initial Filters";t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => ({
  components: {
