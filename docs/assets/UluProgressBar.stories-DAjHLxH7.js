import{an as c,s as m}from"./iframe-DnXSiSwu.js";import"./preload-helper-BJwshlQW.js";const p={component:c,tags:["autodocs"],argTypes:{amount:{control:{type:"range",min:0,max:100,step:1}},total:{control:{type:"number"}},deficit:{control:{type:"range",min:0,max:100,step:1}}}},e={args:{label:"Default Progress",amount:50,total:100}},a={args:{...e.args,label:"Progress with Deficit",amount:60,deficit:20}},s={args:{...e.args,label:"Small Progress",amount:75,small:!0}},r={args:{...e.args,label:"Positive Style",amount:80,positive:!0}},t={args:{...e.args,label:"Negative Style",amount:25,negative:!0}},n={render:i=>({components:{UluProgressBar:c,UluIcon:m},setup(){return{args:i}},template:`
