import{U as a}from"./UluPlaceholderText-B_ftLFXm.js";import"vue";import"./iframe-DYOmpgae.js";import"./preload-helper-BJwshlQW.js";import"vue-router";import"@floating-ui/vue";import"@ulu/utils/templating.js";import"@ulu/utils/browser/dom.js";import"@ulu/frontend";const g={component:a,tags:["autodocs"],argTypes:{amount:{control:{type:"number",min:1,max:10},description:"The number of paragraphs of placeholder text to render."},element:{control:{type:"text"},description:"The HTML element to wrap the text in (e.g., `p`, `div`, `span`)."}},args:{amount:1,element:"p"}},r={render:e=>({components:{UluPlaceholderText:a},setup(){return{args:e}},template:'<UluPlaceholderText v-bind="args" />'}),args:{}},n={render:e=>({components:{UluPlaceholderText:a},setup(){return{args:e}},template:'<UluPlaceholderText v-bind="args" />'}),args:{amount:3}},t={render:e=>({components:{UluPlaceholderText:a},setup(){return{args:e}},template:`
      <div>
