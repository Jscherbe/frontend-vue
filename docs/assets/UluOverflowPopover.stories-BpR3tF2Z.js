import{l as c,S as h,N as w,d as _,b as p,a as x,f as y,e as d,q as O,w as u,O as b,T as U,o as f,v as C,_ as P}from"./iframe-Dmbn_XAG.js";import{u as T}from"./useWindowResize-C6PB_Ujg.js";import"./preload-helper-BJwshlQW.js";const k={class:"layout-flex-baseline"},I={class:"type-word-break"},a={__name:"UluOverflowPopover",props:{triggerIcon:String},setup(s){const{resizing:g,onResizeEnd:m}=T(),n=c(null),l=c(!1),i=()=>{U(()=>{const e=n.value;l.value=e.offsetWidth<e.scrollWidth})},v=m(i);return h(i),w(v),(e,S)=>(f(),_("div",k,[p("div",{class:"type-truncate",ref_key:"text",ref:n},[d(e.$slots,"default")],512),l.value&&!O(g)?(f(),x(b,{key:0,triggerAlt:"Show Full Text",size:"large"},{trigger:u(()=>[C(P,{icon:s.triggerIcon||"type:ellipsis"},null,8,["icon"])]),default:u(()=>[p("div",I,[d(e.$slots,"default")])]),_:3})):y("",!0)]))}};a.__docgenInfo={exportName:"default",displayName:"UluOverflowPopover",description:"",tags:{},props:[{name:"triggerIcon",description:"Default icon for overflow popover trigger",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/collapsible/UluOverflowPopover.vue"]};const $={title:"Components/Collapsible/UluOverflowPopover",component:a,decorators:[()=>({template:`
