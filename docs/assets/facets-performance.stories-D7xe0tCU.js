import{$ as S,a2 as U,a3 as P,a4 as A,a5 as C,a6 as _,I as x}from"./iframe-BcloTimr.js";import{u as I}from"./useFacets-CZFrx-IQ.js";import{u as T}from"./usePagination-l3hIebbP.js";import"./preload-helper-BJwshlQW.js";const j={parameters:{chromatic:{disableSnapshot:!0}}},O=e=>{const i=x(e.items),{facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g}=I(i,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions}),{currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}=T(l,e.itemsPerPage);return{args:e,facets:t,searchValue:o,selectedSort:s,sortTypes:d,displayItems:l,selectedFacets:f,clearFilters:h,handleFacetChange:g,currentPage:y,totalPages:F,paginatedItems:b,pagerItems:v,pagerEllipses:M}},w=`
