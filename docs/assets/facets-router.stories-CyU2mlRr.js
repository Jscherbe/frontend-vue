import{J as i,K as c,L as l,M as n,N as m,O as d,z as u,T as p,S as h}from"./iframe-BJ7lEAgf.js";import{u as F}from"./useFacets-uYsEq1A0.js";import{m as y}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";const A={parameters:{chromatic:{disableSnapshot:!0}}},f=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],g=e=>{const s=u(e.items),r=p(),a=h(),o=F(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions,urlSync:{router:r,route:a}});return{args:e,route:a,...o}},b=`
  <div>
...
})`,...t.parameters?.docs?.source}}};const T=["Default"];export{t as Default,T as __namedExportsOrder,A as default};
