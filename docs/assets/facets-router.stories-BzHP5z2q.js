import{l as i,G as c,I as l}from"./iframe-DEu6WBfK.js";import{_ as m,u as n}from"./UluFacetsFilterAccordions-CiZQQJZp.js";import{_ as d,a as u,b as p,c as h}from"./UluFacetsSort-DiYcdfv3.js";import{_ as F}from"./UluFacetsActiveFilters-Bu0K_pKH.js";import{m as y}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";import"./UluSelectableMenu-DG-8LS2q.js";import"./UluAccordion-BLgurKkC.js";import"./UluCollapsible-DfRlC_wj.js";const k={parameters:{chromatic:{disableSnapshot:!0}}},f=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],g=e=>{const s=i(e.items),r=l(),a=c(),o=n(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType,countMode:e.countMode,searchOptions:e.searchOptions,urlSync:{router:r,route:a}});return{args:e,route:a,...o}},b=`
  <div>
...
`,S={items:y,searchPlaceholder:"Search articles...",maxVisible:5,initialSortType:"az"},t=e=>({components:{UluFacetsFilterAccordions:m,UluFacetsResults:h,UluFacetsSearch:p,UluFacetsSort:u,UluFacetsSidebarLayout:d,UluFacetsActiveFilters:F},setup:()=>g(e),template:b});t.args={...S,facetFields:f,countMode:"intuitive"};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`args => ({
  components: {
...
})`,...t.parameters?.docs?.source}}};const I=["Default"];export{t as Default,I as __namedExportsOrder,k as default};
