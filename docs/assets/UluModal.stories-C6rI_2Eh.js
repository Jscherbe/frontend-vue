import{l as S}from"./fontawesome-DyrJdE5N.js";import{a}from"./iframe-DFeB4tIX.js";import{_ as w}from"./UluButton-zu_C2qC9.js";import{_ as P}from"./UluPlaceholderText-d9tFv5Af.js";import"./preload-helper-BJwshlQW.js";import"./UluAction-CSWkOuPE.js";import"./props-DEaRQ31f.js";const k={component:a,tags:["autodocs"]},e=r=>({components:{UluModal:a,UluButton:w,UluPlaceholderText:P},setup(){const t=S(!1);return{args:r,isModalOpen:t}},template:`
    <div>
...
<\/script>
    ...
    `}),args:{title:"Content Above"}},o=r=>({components:{UluModal:a,UluButton:w},setup(){const t=S(!1);return{args:r,isModalOpen:t}},template:`
    <div>
      <UluButton @click="isModalOpen = true">
        Show Modal
      </UluButton>
  ...
  `}),g={render:o,args:{title:"YouTube (Auto Aspect Ratio)",autoIframe:!0,iframeType:"media"}},M={render:o,args:{title:"YouTube (Wrapped by CMS)",autoIframe:!0,iframeType:"wrapped"}},h={render:o,args:{autoIframe:!0,iframeType:"media"}},v={render:o,args:{title:"External Webpage",modifiers:"large",fullscreenMobile:!0,autoIframe:!0,iframeType:"document"}},U={render:o,args:{title:"External Webpage (Fullscreen)",fullscreen:!0,autoIframe:!0,iframeType:"document"}},T={render:o,args:{title:"YouTube (Pauses by Default)",autoIframe:!0,iframeType:"media"}},b={render:r=>({components:{UluModal:a,UluButton:w},setup(){const t=S(!1);return{args:r,isModalOpen:t}},template:`
      <div>
        <UluButton @click="isModalOpen = true">
          Show Modal
        </UluButton>
    ...
    `}),args:{title:"Native Video (Pauses by Default)"}},y={render:o,args:{title:"YouTube (Do Not Pause Videos)",noPauseVideos:!0,autoIframe:!0,iframeType:"media"}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  render,
  args: {
    title: "Default Modal"
  },
...
<\/script>
  ...
  render: renderIframe,
  args: {
    title: "YouTube (Pauses by Default)",
    autoIframe: true,
    iframeType: 'media'
  }
  ...
  args: {
    title: "Native Video (Pauses by Default)"
  }
}`,...b.parameters?.docs?.source}}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  render: renderIframe,
  args: {
    title: "YouTube (Do Not Pause Videos)",
    noPauseVideos: true,
    autoIframe: true,
    iframeType: 'media'
  }
}`,...y.parameters?.docs?.source}}};const N=["Default","NoTeleport","PositionLeft","PositionRight","PositionLeftResizer","PositionRightResizer","PositionCenterResize","NoPreventScroll","PreventScrollNoPreventScrollShift","ContentAbove","AutoIframeMedia","AutoIframeMediaWrapped","AutoIframeMediaNoHeader","AutoIframeDocument","AutoIframeDocumentFullscreen","PauseVideos","PauseNativeVideo","NoPauseVideos"];export{v as AutoIframeDocument,U as AutoIframeDocumentFullscreen,g as AutoIframeMedia,h as AutoIframeMediaNoHeader,M as AutoIframeMediaWrapped,f as ContentAbove,n as Default,y as NoPauseVideos,p as NoPreventScroll,s as NoTeleport,b as PauseNativeVideo,T as PauseVideos,c as PositionCenterResize,l as PositionLeft,d as PositionLeftResizer,i as PositionRight,u as PositionRightResizer,m as PreventScrollNoPreventScrollShift,N as __namedExportsOrder,k as default};
