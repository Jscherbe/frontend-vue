...
Takes the number as input and should return a string.`,type:{name:"func"},defaultValue:{func:!0,value:"(value) => `${ value }%`"}},{name:"noValue",description:"Hides the percentage value display.",type:{name:"boolean"}},{name:"small",description:"Renders a smaller version of the component.",type:{name:"boolean"}},{name:"outside",description:"Displays the percentage value outside (to the side) of the circle.",type:{name:"boolean"}},{name:"outsideBelow",description:"Displays the percentage value below the circle.",type:{name:"boolean"}},{name:"danger",description:"Applies the 'danger' style.",type:{name:"boolean"}},{name:"warning",description:"Applies the 'warning' style.",type:{name:"boolean"}},{name:"success",description:"Applies the 'success' style.",type:{name:"boolean"}},{name:"pieStyle",description:"Renders the component as a solid pie chart instead of a donut.",type:{name:"boolean"}},{name:"noMask",description:"Removes the center mask, filling the entire circle.",type:{name:"boolean"}},{name:"duration",description:"The duration of the animation in milliseconds.",type:{name:"number"},defaultValue:{func:!1,value:"1000"}},{name:"easing",description:"The easing function for the animation.",type:{name:"string"},defaultValue:{func:!1,value:'"ease-in"'}},{name:"modifiers",description:"Modifiers (to add any modifier classes based on base class)",type:{name:"string|array"}}],slots:[{name:"value",scoped:!0,bindings:[{name:"value",title:"binding"}]}],sourceFiles:["/Users/joescherben/Personal/Projects/ULU/frontend-vue/lib/components/visualizations/UluProgressCircle.vue"]};const K={component:t,tags:["autodocs"],argTypes:{percentage:{control:{type:"range",min:0,max:100,step:1},description:"The progress percentage (0-100)."},danger:{control:"boolean"},warning:{control:"boolean"},success:{control:"boolean"},small:{control:"boolean"},outside:{control:"boolean"},outsideBelow:{control:"boolean"},pieStyle:{control:"boolean"},noMask:{control:"boolean"},noValue:{control:"boolean"},modifiers:{control:"text"},formatValue:{table:{disable:!0}}}},r={args:{label:"Progress",percentage:75}},u={args:{...r.args,label:"No Value",percentage:60,noValue:!0}},p={args:{...r.args,label:"Formatted Value",percentage:80,formatValue:a=>`${a}/100`}},g={render:a=>({components:{UluProgressCircle:t,UluIcon:O},setup(){return{args:a}},template:`
    ...
    `})},b={render:a=>({components:{UluProgressCircle:t,UluButton:T},setup(){const e=w(10);return{args:a,percentage:e,increase:()=>{e.value=Math.min(100,e.value+10)},decrease:()=>{e.value=Math.max(0,e.value-10)}}},template:`
...
}`,...b.parameters?.docs?.source}}};const Q=["Default","NoValue","FormattedValue","CustomValueSlot","WithValueOutside","Small","Statuses","PieStyle","Customizations","Animated"];export{b as Animated,g as CustomValueSlot,f as Customizations,r as Default,p as FormattedValue,u as NoValue,y as PieStyle,m as Small,v as Statuses,d as WithValueOutside,Q as __namedExportsOrder,K as default};
