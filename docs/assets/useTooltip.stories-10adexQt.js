import{aC as c,ba as r,bb as p,bc as u,I as b}from"./iframe-CX9S7sQv.js";import"./preload-helper-BJwshlQW.js";function d(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
