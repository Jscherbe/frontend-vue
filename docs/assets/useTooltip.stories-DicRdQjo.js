import{aC as c,ba as r,bb as p,bc as u,I as b}from"./iframe-oI00zjvw.js";import"./preload-helper-BJwshlQW.js";function d(){const t=c(r),e=c(p),i={...e.popover,...e.tooltip};return{showTooltip:(o,l)=>{const a=u(l,i);a&&t.show(o,a)},hideTooltip:t.hide,tooltipState:t.state}}const T={tags:["autodocs"],parameters:{docs:{description:{component:`The 
      useTooltip
       composable provides a directive-free, programmatic way to control the global tooltip.`}}}},n=t=>({setup(){const{showTooltip:e,hideTooltip:i,tooltipState:s}=d(),o=b(null);return{args:t,buttonEl:o,show:()=>{o.value&&e(o.value,{content:`This tooltip is controlled by a composable!
