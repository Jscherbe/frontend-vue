import{C as o,B as t}from"./iframe-B1ZYXBgx.js";import"./preload-helper-BJwshlQW.js";const l={component:o,tags:["autodocs"],argTypes:{label:{control:"text"},modelValue:{control:"boolean"},required:{control:"boolean"}}},e={render:s=>({components:{UluFormItem:t,UluFormCheckbox:o},setup(){return{args:s}},template:`
