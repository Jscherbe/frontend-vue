import{a0 as F,a3 as b,a4 as y,a5 as f,a6 as S,a7 as U,I as v}from"./iframe-BFkjcG5o.js";import{u as x}from"./useFacets-BDxc_r8Z.js";import{u as P}from"./usePagination-D1X3ZeKf.js";import{m as _}from"./_mock-data-euri91_s.js";import"./preload-helper-BJwshlQW.js";const A={parameters:{chromatic:{disableSnapshot:!0}}},I=[{name:"Category",uid:"category",open:!0,multiple:!0},{name:"Author",uid:"author",open:!0}],T=e=>{const s=v(e.items),{facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m}=x(s,{facetFields:e.facetFields,extraSortTypes:e.extraSortTypes,initialSortType:e.initialSortType}),{currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}=P(a,e.itemsPerPage);return{args:e,facets:r,searchValue:l,selectedSort:i,sortTypes:n,displayItems:a,selectedFacets:o,clearFilters:c,handleFacetChange:m,currentPage:d,totalPages:p,paginatedItems:u,pagerItems:g,pagerEllipses:h}},t=e=>({components:{UluFacetsFilterAccordions:U,UluFacetsResults:S,UluFacetsSearch:f,UluFacetsSort:y,UluFacetsSidebarLayout:b,UluPager:F},setup:()=>T(e),template:`
  ...
  \`
})`,...t.parameters?.docs?.source}}};const $=["SidebarLayout"];export{t as SidebarLayout,$ as __namedExportsOrder,A as default};
