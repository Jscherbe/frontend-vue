<template>
  <div class="UluFacets">
    <div class="UluFacets__header" :class="classes.header">
      <slot name="header" :count="resultsCount"></slot>
    ...
    <div class="UluFacets__body">
      ...
      <div class="UluFacets__results" :class="classes.results">
...
<script>
  ...
  export default {
    ...
    emits: ['update:searchValue', 'update:selectedSort', 'clear-filters', 'facet-change'],
    data() {
      return {
        filterId: `ulu-facet-filters-${ ++idCounter }`,
        sortId: `ulu-facet-sort-${ ++idCounter }`,
        filtersHidden: this.initialFiltersHidden || false,
      }
    },
    methods: {
