...
const Il = { key: 0 }, Tn = {
  ...
  setup(e, { emit: n }) {
    ...
    return (r, l) => (u(), _($s, {
      ...
      default: S(({ option: a }) => [
        $(p(a.label) + " ", 1),
        a.count !== void 0 ? (u(), d("span", Il, "(" + p(a.count) + ")", 1)) : b("", !0)
      ]),
      _: 1
...
}, Yl = { class: "facets-sidebar__header" }, ql = { class: "facets-sidebar__mobile-controls" }, Kl = { class: "facets-sidebar__body" }, Gl = { class: "facets-sidebar__main" }, Dh = {
...
function ec(e, n, t, s, o, i) {
  ...
  return u(), d("table", {
    ...
    t.caption ? (u(), d("caption", Wa, p(t.caption), 1)) : b("", !0),
    h("thead", null, [
