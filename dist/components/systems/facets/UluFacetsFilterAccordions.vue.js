  ...
  setup(i, { emit: g }) {
    ...
    return (c, t) => (l(), d("div", k, [
      (l(!0), d(p, null, x(i.facets, (e) => (l(), m(y, {
        ...
        default: r(() => [
          o(h, {
            children: e.children.slice(0, i.maxVisible),
            groupUid: e.uid,
            groupName: e.name,
            type: e.multiple ? "checkbox" : "radio",
            compact: i.compact,
            "model-value": s(e),
            onFacetChange: t[0] || (t[0] = (a) => n("facet-change", a))
          }, null, 8, ["children", "groupUid", "groupName", "type", "compact", "model-value"]),
          e.children.length > i.maxVisible ? (l(), m(y, {
            key: 0,
            class: N(["facets-filters__more-facets", i.classes.moreFacets]),
            modifiers: i.accordionModifiers
          }, {
            trigger: r(({ isOpen: a }) => [
              f(u(a ? "View Less" : "Show More"), 1)
            ]),
            default: r(() => [
              o(h, {
                children: e.children.slice(i.maxVisible),
                groupUid: e.uid,
                groupName: e.name,
                type: e.multiple ? "checkbox" : "radio",
                compact: i.compact,
                "model-value": s(e),
                onFacetChange: t[1] || (t[1] = (a) => n("facet-change", a))
              }, null, 8, ["children", "groupUid", "groupName", "type", "compact", "model-value"])
            ]),
            _: 2
